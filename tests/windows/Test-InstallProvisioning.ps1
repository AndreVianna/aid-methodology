...
$results = & $mod {
    ...
    rec "SE1d format_version stamped" ($se1 -match '(?m)^format_version: 4')
    rec "SE1e format_version first line" (((Get-Content -LiteralPath "$t\.aid\settings.yml" -TotalCount 1)) -eq 'format_version: 4')
