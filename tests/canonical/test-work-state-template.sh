...
WORK_STATE="${REPO_ROOT}/canonical/templates/work-state-template.md"
DELIVERY_STATE="${REPO_ROOT}/canonical/templates/delivery-state-template.md"
TASK_STATE="${REPO_ROOT}/canonical/templates/task-state-template.md"
DELIVERY_SPEC="${REPO_ROOT}/canonical/templates/delivery-spec-template.md"
TASK_SPEC="${REPO_ROOT}/canonical/templates/task-spec-template.md"
