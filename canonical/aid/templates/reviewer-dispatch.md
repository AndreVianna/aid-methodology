...
This document lives in `canonical/aid/templates/` and is a **skill-bundle artifact**, not a KB document.
...
- `canonical/agents/aid-reviewer/` — the deep reviewer; `canonical/agents/aid-screener/` — the screener
