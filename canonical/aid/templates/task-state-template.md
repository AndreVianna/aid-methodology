...
`canonical/aid/templates/connectors/consumption-protocol.md`). The flattened path (no per-task
...
<!-- AUTHORED -- appended by the dispatcher on subagent completion (L1+L2+L3 traceability;
     ...
     Source: `canonical/skills/aid-discover/SKILL.md ## Dispatch Protocol`. -->
