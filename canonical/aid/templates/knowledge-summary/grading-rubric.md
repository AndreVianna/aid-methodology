...
```
$ bash canonical/aid/scripts/summarize/emit-summary-findings.sh .aid/knowledge/kb.html --dry-run
...
```
$ bash canonical/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/summary.md
OK: check-gaps.sh: no open criteria gap; grading may proceed

$ bash canonical/aid/scripts/grade.sh --explain .aid/.temp/review-pending/summary.md
