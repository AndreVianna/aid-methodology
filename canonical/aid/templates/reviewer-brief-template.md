...
RULE SET: {{RULE_SET}} -- resolve via canonical/aid/templates/review-rubrics/INDEX.md
  Severity is a LOOKUP against the violated rule's anchor, per
  canonical/aid/templates/grading-rubric.md#severity-scale. Do not invent a band.
...
MISSING CRITERIA:
  ...
  see canonical/aid/templates/criteria-gap-protocol.md. Do NOT invent a criterion,
