...
[`canonical/aid/templates/grading-rubric.md#severity-scale`](../grading-rubric.md#severity-scale).
...
- [`canonical/aid/templates/reviewer-ledger-schema.md`](../reviewer-ledger-schema.md) — the ledger
  the `Rule` column lives in
- [`canonical/aid/templates/kb-authoring/review-rubric.md`](../kb-authoring/review-rubric.md) — the
