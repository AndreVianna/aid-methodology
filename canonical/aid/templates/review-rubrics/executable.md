...
| `EXE-09` | A script carries the declared file header | `coding-standards.md § File Header Convention` | SHOULD | mechanical | Check the first lines of each new script against the declared header shape | `[LOW]; escaped (>1 file) → [MEDIUM]` |
