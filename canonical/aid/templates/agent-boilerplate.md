...
speculatively. See `canonical/aid/templates/subagent-heartbeat-protocol.md` for
the full contract.
...
`canonical/aid/templates/subagent-heartbeat-protocol.md` §Cooperative
...
Apply regardless of task size. See `canonical/aid/templates/self-review-protocol.md`
