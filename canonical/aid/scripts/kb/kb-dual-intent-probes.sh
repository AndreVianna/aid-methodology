...
_dim_of_filename() {
  ...
  case "$fn" in
    ...
    # C7 Risk & debt
    tech-debt.md|limitations.md|backlog.md) _DIM_OUT="C7" ;;
    # C8 Shipping & operation
    infrastructure.md|delivery-pipeline.md|dissemination.md|\
    publishing-pipeline.md|release-tracking.md) _DIM_OUT="C8" ;;
    ...
    decisions.md|experiment-log.md|findings-log.md|roadmap.md) _DIM_OUT="D" ;;
...
_run_work_probes() {
  ...
  echo ""
    echo "**Severity:** Any load-bearing ASSUMED or REACH step is an [ACTBACK] insufficiency, at the"
    echo "severity its cited rule anchors -- [HIGH] for KB-22..KB-25, [LOW] for KB-26, Step 2 for"
    echo "KB-20/KB-21. It is NOT fixed here: an unstated convention is a KB-26 finding at [LOW]."
