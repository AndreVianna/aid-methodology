...
<!-- AUTO-GENERATED $TS by canonical/scripts/kb/build-index.sh -->
<!-- DO NOT EDIT — regenerate with: bash canonical/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/generated/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash canonical/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/generated/INDEX.md\`.*"
