...
```bash
KB_STAGE=$(bash canonical/aid/scripts/housekeep/housekeep-state.sh \
...
`canonical/aid/scripts/config/read-setting.sh --skill summary --key minimum_grade
...
approved. Do NOT edit anything in `canonical/skills/aid-summarize/` — the skill
runs unmodified.
...
(`canonical/skills/aid-summarize/SKILL.md:60`).
