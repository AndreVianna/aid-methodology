...
**not** use `canonical/aid/scripts/works/worktree-lifecycle.sh` or
`canonical/aid/templates/work-initiation-gate.md` -- both hard-validate a
...
of `canonical/aid/templates/worktree-lifecycle.md § Step 2` only.
