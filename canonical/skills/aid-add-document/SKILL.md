...
description: >
  ...
  defined by canonical/skills/aid-create-document/SKILL.md.
...
(`canonical/skills/aid-create-document/SKILL.md`), per the alias-is-a-full-directory
convention the shortcut catalog uses (an alias is a full, separate
`canonical/skills/<name>/SKILL.md` directory, not a redirect the generator resolves).
...
`canonical/skills/aid-create-document/SKILL.md`. Read that file and execute it exactly
