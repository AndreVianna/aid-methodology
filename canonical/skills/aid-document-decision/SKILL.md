...
description: >
  ...
  into `.aid/knowledge/`. A thin kind-sibling of `/aid-create-document`, which defines its
  full behavior.
...
Deeper genre structures: `canonical/aid/templates/shortcut-scaffolding/document.md`.
