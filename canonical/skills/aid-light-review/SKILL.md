...
Read the invocation manifest (`canonical/aid/templates/reviewer-brief-template.md` § invocation
...
- `canonical/agents/aid-screener/AGENT.md` — the agent dispatched here
- `canonical/aid/templates/reviewer-brief-template.md` — the invocation manifest
