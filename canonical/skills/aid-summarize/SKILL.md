...
See `canonical/aid/templates/knowledge-summary/grading-rubric.md` for the complete rubric and grade boundaries.

---

## References

- `canonical/aid/templates/knowledge-summary/prompt.md` — agent guidance for the GENERATE step (long-form)
...
- `canonical/aid/templates/knowledge-summary/mermaid-init.js` — Mermaid theme variables for both modes (kept for D-011; retired in D-012)
- `canonical/aid/templates/knowledge-summary/mermaid-examples.md` — diagram syntax patterns + pitfalls (kept for D-011; retired in D-012)
