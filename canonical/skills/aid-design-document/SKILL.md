...
description: >
  Develop a document design as a DESIGN SEED in .aid/design/document.md -- the
  document's kind and structure, its audience, and its placement. Grounded in the
  ...
  /aid-create-document once it is ready. To write a general document now rather
  than develop its direction as a seed, use /aid-document. Produced by the
