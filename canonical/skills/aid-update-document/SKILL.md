...
(`canonical/skills/aid-change-document/SKILL.md`), per the alias-is-a-full-directory
...
constraint -- is defined exclusively by `canonical/skills/aid-change-document/SKILL.md`.
