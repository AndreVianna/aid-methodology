...
```bash
bash canonical/aid/scripts/review/check-gaps.sh --ledger <durable>   # 0 clean, 1 open criteria gap
```
...
```bash
bash canonical/aid/scripts/grade.sh --explain <durable>
```
...
- `canonical/aid/templates/reviewer-brief-template.md` — brief and manifest
- `canonical/aid/templates/review-rubrics/INDEX.md` — rule-set routing
- `canonical/aid/templates/criteria-gap-protocol.md` — the gate and the register
- `canonical/aid/templates/reviewer-ledger-schema.md` — the ledger and reconciliation
