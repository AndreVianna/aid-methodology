...
**Cross-references.**
- `canonical/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `canonical/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `canonical/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`canonical/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
