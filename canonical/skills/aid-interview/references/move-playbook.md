...
`canonical/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `canonical/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`canonical/skills/aid-interview/references/advisor-stance.md`.
...
`canonical/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `canonical/skills/aid-interview/references/elicitation-engine.md` for the full
