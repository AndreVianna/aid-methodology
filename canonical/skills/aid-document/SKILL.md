...
description: >
  ...
  NEVER writes into .aid/knowledge/. To develop a document's direction as a reusable
  design seed first, use /aid-design-document. This file carries no logic of its own -- its full
