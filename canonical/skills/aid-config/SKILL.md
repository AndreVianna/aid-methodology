...
```bash
bash canonical/aid/scripts/config/read-setting.sh --key minimum_grade --default A
```
...
Canonical schema: `canonical/aid/templates/settings.yml`. Flat top-level scalar keys
