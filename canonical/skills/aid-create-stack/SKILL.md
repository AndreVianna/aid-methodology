...
description: >
  Realize a ready stack seed from .aid/design/stack.md into the project's
  technology (C0) Knowledge Base document -- languages, runtimes, frameworks,
  package managers, and build and test tooling, each with its version. When it
  ...
  revise C0 content this lifecycle already committed, use /aid-update-stack; to
  create or revise a configuration option within a chosen stack rather than the
  stack itself, use /aid-create-config or /aid-update-config. Produced by the
