...
> owning-table in `canonical/aid/templates/kb-authoring/concern-model.md`
...
skill under `canonical/skills/` reads backlog.md at tag time, so nothing a project installs
