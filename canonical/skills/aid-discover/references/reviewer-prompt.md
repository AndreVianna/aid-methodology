...
>
> 6. **Meta-document integrity** — INDEX.md, README.md, and {project_context_file} are
...
>    - Are questions marked Pending in the Q&A section of {reviewer_output_file} actually still unanswerable from the repository?
>
...
>
> **After grading, add new questions to the `## Q&A` section of {reviewer_output_file}** for any
...
>
> Write the review results (grades, issues, spot-checks) to {reviewer_output_file},
