...
Run `canonical/scripts/kb/verify-claims.sh .aid/knowledge/` to check all 16 files exist.
...
Run `canonical/scripts/kb/verify-claims.sh .aid/knowledge/` one final time.
