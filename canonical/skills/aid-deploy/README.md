...
- `work STATE.md `## Tasks State`` files — per-task review and test outcomes.
...
- [ ] All tasks passed review with grade A- or above (see work STATE.md `## Tasks State`).
- [ ] All TEST task outcomes in work STATE.md `## Tasks State` are green.
...
- Lint: ✅ clean
- Staging: ✅ TEST task outcomes in work STATE.md `## Tasks State` passed
...
- SPEC.md rev {version}
- work STATE.md `## Tasks State` files
```
...
2. Update each `work STATE.md `## Tasks State``:
   - Status: Complete
...
- Updated work STATE.md `## Tasks State` files (status: Complete).
...
- [ ] Delivery-NNN entry in PLAN.md and work STATE.md `## Tasks State` files updated to Complete.
