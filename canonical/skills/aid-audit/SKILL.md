...
description: >
  ...
  of its own -- its full behavior is defined by canonical/skills/aid-review/SKILL.md.
...
`/aid-audit` is the alias of **`/aid-review`** (`canonical/skills/aid-review/SKILL.md`),
per the same alias-is-a-full-directory convention the shortcut catalog uses
(`canonical/aid/templates/shortcut-catalog.yml` Topology note: an alias is a full,
separate `canonical/skills/<name>/SKILL.md` directory, not a redirect the generator
...
and every constraint -- is defined exclusively by `canonical/skills/aid-review/SKILL.md`.
