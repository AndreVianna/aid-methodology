...
`/aid-investigate` is the alias of **`/aid-research`** (`canonical/skills/aid-research/SKILL.md`),
...
is defined exclusively by `canonical/skills/aid-research/SKILL.md`. Read that file and
