...
```bash
bash canonical/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/execute-delivery-NNN.md   # exit 1 = an open criteria gap; do NOT grade
...
bash canonical/aid/scripts/execute/writeback-state.sh --pipeline --field "Block Artifact" --value ".aid/works/{work}/IMPEDIMENT-delivery-{NNN}.md"
bash canonical/aid/scripts/execute/writeback-state.sh --pipeline --field Updated --value "$(date -u +%Y-%m-%dT%H:%M:%SZ)"
```
...
```bash
bash canonical/aid/scripts/execute/writeback-state.sh --delivery-id NNN --gate-field Tier --gate-value "{Small|Medium|Large}"
bash canonical/aid/scripts/execute/writeback-state.sh --delivery-id NNN --gate-field Grade --gate-value "{grade}"
bash canonical/aid/scripts/execute/writeback-state.sh --delivery-id NNN --gate-field Timestamp --gate-value "$(date -u +%Y-%m-%dT%H:%M:%SZ)"
bash canonical/aid/scripts/execute/writeback-state.sh --delivery-id NNN --block "BLOCK"
```
