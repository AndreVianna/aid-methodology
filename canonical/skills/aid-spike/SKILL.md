...
description: >
  ...
  behavior is defined by canonical/skills/aid-research/SKILL.md.
...
`/aid-spike` is the alias of **`/aid-research`** (`canonical/skills/aid-research/SKILL.md`),
...
`canonical/skills/aid-research/SKILL.md` -- including the **feasibility-spike escalation**
