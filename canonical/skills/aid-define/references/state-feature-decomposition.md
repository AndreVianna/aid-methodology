...
bash canonical/aid/scripts/execute/writeback-state.sh --pipeline --field Phase --value Interview
bash canonical/aid/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value aid-define
