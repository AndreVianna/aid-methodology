...
- **Ledger lifecycle:** "Append new findings as rows with Status: Pending to
  ...
  `bash canonical/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/interview-<work>-cross-ref.md` (exit 1 = an open criteria gap; do not grade), then `bash canonical/aid/scripts/grade.sh .aid/.temp/review-pending/interview-<work>-cross-ref.md`
...
```bash
bash canonical/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/interview-<work>-cross-ref.md   # exit 1 = an open criteria gap; do NOT grade
bash canonical/aid/scripts/grade.sh --explain .aid/.temp/review-pending/interview-<work>-cross-ref.md
```
