...
- **→ Specify:** SPEC missing detail → Q&A entry appended to the `qa` sequence in the owning `deliveries/delivery-NNN/STATE.yml` (spec-tagged) — per FR2; pre-FR2 this lived in the feature's `STATE.md`
