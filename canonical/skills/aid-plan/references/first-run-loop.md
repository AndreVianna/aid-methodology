...
**4a. Create `delivery-NNN/SPEC.md`** (seed from `canonical/templates/delivery-spec-template.md`):
...
**4b. Create `delivery-NNN/STATE.md`** (seed from `canonical/templates/delivery-state-template.md`):
