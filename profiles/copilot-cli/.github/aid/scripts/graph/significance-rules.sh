...
sig_artifact_class_into() {
    local p="${1#int:}"
    case "$p" in
        .github/skills/*/)                       SIG_ARTIFACT_CLASS="skill" ;;
        .github/agents/*/)                       SIG_ARTIFACT_CLASS="agent" ;;
        ...
        .aid/settings.yml|.github/aid/templates/settings.yml)
                                                   SIG_ARTIFACT_CLASS="settings-schema" ;;
        canonical/EMISSION-MANIFEST.md|*/package.json|*/pyproject.toml|.github/aid/templates/generated-files.txt)
                                                   SIG_ARTIFACT_CLASS="manifest" ;;
        tests/*)                                   SIG_ARTIFACT_CLASS="test-suite" ;;
        .github/aid/templates/*)                 SIG_ARTIFACT_CLASS="template" ;;
        dashboard/*)                               SIG_ARTIFACT_CLASS="dashboard-module" ;;
        site/*)                                    SIG_ARTIFACT_CLASS="site-module" ;;
        .github/aid/scripts/*|*.sh|*.ps1|*.psm1|*.py)
