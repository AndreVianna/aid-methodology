...
//   (`.github/aid/scripts/summarize/assemble.sh`) already validates for
...
function main() {
	...
	const templatesDir = path.join(repoRoot, '.github/aid/templates/knowledge-graph');
	const summaryTemplatesDir = path.join(repoRoot, '.github/aid/templates/knowledge-summary');
	const predicatePath = path.join(repoRoot, '.github/aid/scripts/graph/coverage-predicate.mjs');
	const scaleCeilingPath = path.join(repoRoot, '.github/aid/templates/graph/scale-ceiling.yml');
	...
	// vendors .github/aid/templates/knowledge-graph/vendor/, present after, no
