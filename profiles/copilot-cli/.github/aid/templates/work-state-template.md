...
consumption contract: `.github/aid/templates/connectors/consumption-protocol.md`. Coordinate
...
<!-- AUTHORED -- single-delivery FLATTENED works only (see ## Delivery Lifecycle note above).
     ...
     `.aid/works/{work}/delivery-001-issues.md`; see `.github/aid/templates/delivery-issues.md`) and runs
