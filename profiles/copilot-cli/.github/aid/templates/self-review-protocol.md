...
`bash .github/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.github/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.github/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
