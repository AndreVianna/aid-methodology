...
- `.github/aid/templates/shortcut-scaffolding/create.md` -- the artifact
  matrix (SPEC sections + task breakdown) this file inherits by reference
- `.github/aid/templates/shortcut-scaffolding/analyze-report.md § aid-review /
  § aid-research` -- where the decision to remove/deprecate/migrate gets
  assessed before this file's verbs act on it
- `.github/aid/templates/shortcut-engine.md § Family Scaffolding Consult` --
...
- `.github/skills/aid-execute/references/task-type-rules.md ## MIGRATE /
