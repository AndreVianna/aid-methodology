...
<!-- OPTIONAL `ticket_ref` -- e.g. `jira:PROJ-123`; links this feature to an external tracker
     ...
     contract: `.github/aid/templates/connectors/consumption-protocol.md`. This is a SPEC body
...
`.github/aid/templates/requirements/requirements-template.md § Verifiable
