...
RULE SET: {{RULE_SET}} -- resolve via .github/aid/templates/review-rubrics/INDEX.md
  Severity is a LOOKUP against the violated rule's anchor, per
  .github/aid/templates/grading-rubric.md#severity-scale. Do not invent a band.
...
MISSING CRITERIA:
  ...
  see .github/aid/templates/criteria-gap-protocol.md. Do NOT invent a criterion,
