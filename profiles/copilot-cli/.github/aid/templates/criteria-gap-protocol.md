...
```bash
bash .github/aid/scripts/review/check-gaps.sh --ledger <path>   # 0 clean, 1 open criteria gap
bash .github/aid/scripts/grade.sh --explain <path>              # only reachable on exit 0
```
