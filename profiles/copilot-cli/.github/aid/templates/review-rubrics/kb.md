...
| `KB-04` | The core frontmatter fields are present: `objective:`, `summary:`, `sources:` | `authoring-conventions.md § Frontmatter Rules` | MUST | mechanical | `bash .github/aid/scripts/kb/lint-frontmatter.sh --root <dir>` | `[HIGH]` |
