...
| `PRO-04` | A release artifact's version carriers agree | `release-tracking.md` — the section declaring the version carriers | MUST | mechanical | `bash .github/aid/scripts/release/check-version-sync.sh --expect <version>` | `Step 2` |
