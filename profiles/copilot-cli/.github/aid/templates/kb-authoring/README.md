...
All three builders are registered in `.github/aid/templates/generated-files.txt`
...
- `.github/agents/aid-reviewer/AGENT.md` — adversarial review (semantic + frontmatter + spot-check; the sole KB-quality enforcer)
- `.github/aid/scripts/kb/build-metrics.sh` — T3 fact generator
- `.github/aid/scripts/kb/build-kb-index.sh` — INDEX.md generator
- `.github/aid/scripts/kb/build-project-index.sh` — project-index.md generator
- `.github/aid/templates/generated-files.txt` — registry of all generated files + build commands
- `.github/aid/templates/knowledge-base/*.md` — KB doc templates pre-filled with frontmatter
