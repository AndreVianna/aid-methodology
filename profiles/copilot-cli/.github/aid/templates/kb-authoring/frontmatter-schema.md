...
Name of the build script (relative to `.github/aid/scripts/` or as a
project-relative path). Listed in `.github/aid/templates/generated-files.txt` registry.
...
- Each entry is one of:
  - A **repo-relative path** (`src/foo.ts`, `.github/aid/scripts/kb/`)
  - A **glob** (`src/parsers/*.py`, `.github/aid/templates/*.md`)
...
```yaml
sources:
  - .github/aid/templates/knowledge-base/
