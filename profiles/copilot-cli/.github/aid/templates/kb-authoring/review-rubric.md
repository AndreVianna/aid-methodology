...
[`.github/aid/templates/grading-rubric.md#severity-scale`](.github/aid/templates/grading-rubric.md#severity-scale). Modality sets the band; blast radius
and reversibility select within the MUST band. Not restated here.

Worst-issue dominates the grade (per `.github/aid/templates/grading-rubric.md`).
...
Per `.github/aid/templates/grading-rubric.md`, the grade is COMPUTED from the severity
