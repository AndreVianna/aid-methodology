...
1. **Type** — read the file's path and frontmatter and resolve its **one** document type from
   ...
   `.github/skills/`, `.github/agents/`, `.github/aid/templates/` and `.aid/knowledge/`.
...
`.github/aid/templates/grading-rubric.md § Issue Severities`; classify against that document
