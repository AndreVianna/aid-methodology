...
2. **Create and enter the worktree, BEFORE authoring anything:**
   ...
   the resolved path per `.github/aid/templates/worktree-lifecycle.md § Step
...
2. **Locate:**
   ...
   ```bash
   bash .github/aid/scripts/works/worktree-lifecycle.sh locate <work-id>
   ```
...
4. **Enter** (rungs 1-3 -- `registered | recreated | created`), unless
   ...
   `.github/aid/templates/worktree-lifecycle.md § Step 2`, invoke the
