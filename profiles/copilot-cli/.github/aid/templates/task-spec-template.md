...
[!NOTE]
This is the TASK-LEVEL SPEC.md template. It is the IMMUTABLE DEFINITION for this task.
Written once by aid-detail; not a state file. State lives in task-NNN/STATE.md.
Shape: 6 sections matching .github/aid/templates/delivery-plans/task-template.md.
