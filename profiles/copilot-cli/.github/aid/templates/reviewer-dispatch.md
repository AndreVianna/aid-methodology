...
```
RUBRIC:
  .github/aid/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .github/aid/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.github/aid/templates/grading-rubric.md`
...
```
ARTIFACTS UNDER REVIEW:
  - .github/aid/templates/kb-authoring/README.md
  - .github/aid/templates/kb-authoring/principles.md
  - .github/aid/templates/kb-authoring/tier-model.md
  - .github/aid/templates/kb-authoring/frontmatter-schema.md
  - .github/aid/templates/kb-authoring/review-rubric.md
  - .github/aid/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .github/aid/templates/generated-files.txt
  - .github/aid/scripts/kb/build-metrics.sh
  - .github/aid/scripts/kb/build-kb-index.sh
  - .github/aid/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .github/aid/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
This doc lives in `.github/aid/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.github/aid/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.github/aid/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.github/aid/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.github/aid/templates/grading-rubric.md` — severity → grade computation
- `.github/aid/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
