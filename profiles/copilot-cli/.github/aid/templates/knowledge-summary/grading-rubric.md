...
The skill's `VALIDATE` state runs `.github/aid/scripts/grade.sh` against the generated
...
```
$ bash .github/aid/scripts/grade.sh .aid/knowledge/knowledge-summary.html
