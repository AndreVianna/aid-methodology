...
`node .github/aid/scripts/summarize/validate-visuals.mjs .aid/knowledge/kb.html`
...
```
$ bash .github/aid/scripts/summarize/emit-summary-findings.sh .aid/knowledge/kb.html --dry-run
...
```
$ bash .github/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/summarize.md
