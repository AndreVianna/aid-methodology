...
description: >
  ...
  by .github/skills/aid-prototype/SKILL.md, with "ui" as the prototype target.
...
(`.github/skills/aid-prototype/SKILL.md`) -- not an alias: it is its own catalog row
...
**This file has no logic of its own.** Execute `.github/skills/aid-prototype/SKILL.md`
