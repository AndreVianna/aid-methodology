...
Scan `.github/recipes/` relative to the AID installation root (the same directory that
...
`.github/recipes/` relative to the AID installation root, i.e. the same directory
