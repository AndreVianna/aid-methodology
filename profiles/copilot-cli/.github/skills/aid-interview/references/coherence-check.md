...
**Cross-references.**
- `.github/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `.github/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `.github/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.github/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
