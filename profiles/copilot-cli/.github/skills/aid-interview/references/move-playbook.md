...
`.github/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.github/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`.github/skills/aid-interview/references/advisor-stance.md`.
...
`.github/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `.github/skills/aid-interview/references/elicitation-engine.md` for the full
