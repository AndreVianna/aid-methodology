...
Compare to minimum grade from `bash .github/aid/scripts/config/read-setting.sh --skill interview --key minimum_grade --default A`.
...
- **Status:** Pending
- **Context:** {why this matters; what evidence was found; surfaced by /aid-define (cross-reference)}
