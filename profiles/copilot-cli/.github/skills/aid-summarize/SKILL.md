...
- `.github/aid/templates/knowledge-summary/mermaid-init.js` — Mermaid theme variables for both modes (kept for D-011; retired in D-012)
- `.github/aid/templates/knowledge-summary/mermaid-examples.md` — diagram syntax patterns + pitfalls (kept for D-011; retired in D-012)
