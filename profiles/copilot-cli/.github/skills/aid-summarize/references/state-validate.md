...
`.aid/.temp/review-pending/summarize.md` (per `.github/templates/reviewer-ledger-schema.md`):
...
```bash
bash .github/scripts/grade.sh --explain .aid/.temp/review-pending/summarize.md
```
