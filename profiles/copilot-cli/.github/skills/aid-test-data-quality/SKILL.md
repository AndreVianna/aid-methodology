...
description: >
  ...
  its full behavior is defined by .github/skills/aid-test/SKILL.md.
...
(`.github/skills/aid-test/SKILL.md`) -- not an alias: its own catalog row
(`alias_of: null`, `{verb: test, artifact: data-quality}`), `repurpose: true`
(hand-authored). It carries **no logic of its own.**

Execute `.github/skills/aid-test/SKILL.md` exactly as written, with the verification
