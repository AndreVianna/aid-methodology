...
description: >
  ...
  .github/skills/aid-research/SKILL.md.
...
`/aid-investigate` is the alias of **`/aid-research`** (`.github/skills/aid-research/SKILL.md`),
...
is defined exclusively by `.github/skills/aid-research/SKILL.md`. Read that file and
