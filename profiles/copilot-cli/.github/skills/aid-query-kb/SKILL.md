...
4. Compose the answer with inline citations:
   ...
   - File path: cite as `.github/skills/aid-query-kb/SKILL.md`.
...
`.github/aid/templates/connectors/consumption-protocol.md` (scan `.aid/connectors/INDEX.md`;
...
- <citation 2>  (e.g., `.github/skills/aid-housekeep/SKILL.md`)
