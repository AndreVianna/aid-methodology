...
```bash
bash .github/aid/scripts/kb/kb-citation-lint.sh --root .aid/knowledge
```
...
```bash
bash .github/aid/scripts/kb/lint-frontmatter.sh --root .aid/knowledge --fail-on-skip
```
