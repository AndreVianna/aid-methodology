...
> owning-table in `.github/aid/templates/kb-authoring/concern-model.md`
...
skill under `.github/skills/` reads backlog.md at tag time, so nothing a project installs
