...
`.github/aid/scripts/kb/kb-dual-intent-probes.sh work`) and the operational-structure
presence check (output of `.github/aid/scripts/kb/kb-actback-task.sh check`) below. The
