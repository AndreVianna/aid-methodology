...
`.github/aid/scripts/review/writeback-ledger.sh --set-status` to carry a row forward and
...
```bash
bash .github/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/{{SCOPE}}.md   # exit 1 = an open criteria gap; do NOT grade
bash .github/aid/scripts/grade.sh --explain .aid/.temp/review-pending/{{SCOPE}}.md
```
