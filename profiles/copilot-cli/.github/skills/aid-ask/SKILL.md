...
description: >
  ...
  .github/skills/aid-query-kb/SKILL.md, which this skill delegates to.
...
(`.github/skills/aid-query-kb/SKILL.md`) -- `aid-query-kb` was renamed FROM
...
(`.github/aid/templates/shortcut-catalog.yml`'s Topology note: an alias is a
full, separate `.github/skills/<name>/SKILL.md` directory -- not a redirect
...
exclusively by `.github/skills/aid-query-kb/SKILL.md`. Read that file and
...
Same as `aid-query-kb`'s own Pre-flight (`.github/skills/aid-query-kb/SKILL.md
...
Delegate to `.github/skills/aid-query-kb/SKILL.md § Execution: answer the
