...
`.github/skills/aid-describe/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.github/skills/aid-describe/references/elicitation-engine.md` -- the engine driver
...
`.github/skills/aid-describe/references/advisor-stance.md`.
...
`.github/skills/aid-describe/references/elicitation-engine.md` reads this table. The
...
See `.github/skills/aid-describe/references/elicitation-engine.md` for the full
