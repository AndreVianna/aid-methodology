...
**Cross-references.**
- `.github/skills/aid-describe/references/move-playbook.md` -- the ten moves and
  the gap-type -> move firing table that Step 3 (MOVE SELECTION) reads each turn.
- `.github/skills/aid-describe/references/calibration.md` -- the continuous
...
| Move playbook | `.github/skills/aid-describe/references/move-playbook.md` |
| Calibration state | `.github/skills/aid-describe/references/calibration.md` |
| NFR-7 invariant | `.github/skills/aid-describe/references/advisor-stance.md` |
...
Delegate to `.github/skills/aid-describe/references/move-playbook.md`. Read the
...
Delegate to `.github/skills/aid-describe/references/calibration.md`. Read the
...
Delegate to `.github/skills/aid-describe/references/advisor-stance.md`:
...
`.github/skills/aid-triage/SKILL.md`). It is a UX-shape consumer, not a three-parameter
