...
description: >
  ...
  defined by .github/skills/aid-create-document/SKILL.md.
...
(`.github/skills/aid-create-document/SKILL.md`), per the alias-is-a-full-directory
convention the shortcut catalog uses (an alias is a full, separate
`.github/skills/<name>/SKILL.md` directory, not a redirect the generator resolves).
...
`.github/skills/aid-create-document/SKILL.md`. Read that file and execute it exactly
