...
`aid-reviewer` sub-agent. Follows `.github/templates/reviewer-dispatch.md`.
...
DELIVERABLES:
  ...
  - Grade: per .github/scripts/grade.sh; minimum resolved via
    `bash .github/scripts/config/read-setting.sh --skill specify --key minimum_grade --default A`
