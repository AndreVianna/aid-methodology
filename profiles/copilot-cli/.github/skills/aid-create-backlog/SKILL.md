...
description: >
  ...
  .aid/knowledge/README.md on first creation. Routes to /aid-update-backlog when the item
  sections already carry committed content.
...
skill under the shared contract in `.github/aid/templates/design-lifecycle.md` (class 1),
