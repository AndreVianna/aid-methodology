...
description: >
  ...
  of its own -- its full behavior is defined by .github/skills/aid-review/SKILL.md.
...
`/aid-audit` is the alias of **`/aid-review`** (`.github/skills/aid-review/SKILL.md`),
per the same alias-is-a-full-directory convention the shortcut catalog uses
(`.github/aid/templates/shortcut-catalog.yml` Topology note: an alias is a full,
separate `.github/skills/<name>/SKILL.md` directory, not a redirect the generator
...
and every constraint -- is defined exclusively by `.github/skills/aid-review/SKILL.md`.
