...
name: aid-triage
description: >
  Suggest which AID entry point fits the work you are describing. Use this skill when you
...
> `.github/aid/templates/state-machine-chaining.md`. Every state here is
