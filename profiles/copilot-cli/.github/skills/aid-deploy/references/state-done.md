...
```
bash .github/aid/scripts/execute/writeback-state.sh --pipeline --field Lifecycle --value Completed
bash .github/aid/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value none
