...
`.github/aid/templates/requirements/requirements-template.md § Verifiable Acceptance Criteria`):
...
Seeded from `.github/aid/templates/delivery-state-template.yml` with:
