...
description: >
  ...
  .github/skills/aid-change-document/SKILL.md.
...
(`.github/skills/aid-change-document/SKILL.md`), per the alias-is-a-full-directory
...
constraint -- is defined exclusively by `.github/skills/aid-change-document/SKILL.md`.
