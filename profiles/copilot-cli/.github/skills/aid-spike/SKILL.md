...
description: >
  ...
  behavior is defined by .github/skills/aid-research/SKILL.md.
...
`/aid-spike` is the alias of **`/aid-research`** (`.github/skills/aid-research/SKILL.md`),
...
`.github/skills/aid-research/SKILL.md` -- including the **feasibility-spike escalation**
