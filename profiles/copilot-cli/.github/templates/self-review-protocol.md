...
`bash .github/scripts/...`." Don't just fix the cited file. Grep:
...
- `.github/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.github/templates/subagent-heartbeat-protocol.md` — the heartbeat
