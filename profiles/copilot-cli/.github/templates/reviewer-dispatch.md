...
DELIVERABLES:
  - Findings ledger at `.aid/.temp/review-pending/<scope>.md` per
    `.github/templates/reviewer-ledger-schema.md`
...
wildcards beyond the artifact set (e.g., `.github/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .github/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .github/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.github/templates/grading-rubric.md`
...
`.github/skills/<skill>/references/reviewer-brief.md`. Six per-skill briefs
...
```
ARTIFACTS UNDER REVIEW:
  - .github/templates/kb-authoring/README.md
  - .github/templates/kb-authoring/principles.md
  - .github/templates/kb-authoring/tier-model.md
  - .github/templates/kb-authoring/frontmatter-schema.md
  - .github/templates/kb-authoring/review-rubric.md
  - .github/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .github/templates/generated-files.txt
  - .github/scripts/kb/build-metrics.sh
  - .github/scripts/kb/build-kb-index.sh
  - .github/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .github/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
This doc lives in `.github/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.github/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.github/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.github/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.github/templates/grading-rubric.md` — severity → grade computation
- `.github/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
- `.github/agents/aid-reviewer/` — the reviewer agent definition
