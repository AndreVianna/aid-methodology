...
into one auto-generated file. See .github/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .github/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .github/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .github/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.github/scripts/kb/build-metrics.sh\`.*"
