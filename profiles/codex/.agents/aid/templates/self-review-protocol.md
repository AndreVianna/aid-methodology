...
`bash .agents/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.agents/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.agents/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
