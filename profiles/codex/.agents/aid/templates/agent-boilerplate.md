...
speculatively. See `.agents/aid/templates/subagent-heartbeat-protocol.md` for
the full contract.
...
Apply regardless of task size. See `.agents/aid/templates/self-review-protocol.md`
