...
The skill's `VALIDATE` state runs `.agents/aid/scripts/grade.sh` against the generated
...
```
$ bash .agents/aid/scripts/grade.sh .aid/knowledge/knowledge-summary.html
