...
wildcards beyond the artifact set (e.g., `.agents/aid/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .agents/aid/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .agents/aid/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.agents/aid/templates/grading-rubric.md`
...
```
ARTIFACTS UNDER REVIEW:
  - .agents/aid/templates/kb-authoring/README.md
  - .agents/aid/templates/kb-authoring/principles.md
  - .agents/aid/templates/kb-authoring/tier-model.md
  - .agents/aid/templates/kb-authoring/frontmatter-schema.md
  - .agents/aid/templates/kb-authoring/review-rubric.md
  - .agents/aid/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .agents/aid/templates/generated-files.txt
  - .agents/aid/scripts/kb/build-metrics.sh
  - .agents/aid/scripts/kb/build-kb-index.sh
  - .agents/aid/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .agents/aid/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
This doc lives in `.agents/aid/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.agents/aid/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.agents/aid/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.agents/aid/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.agents/aid/templates/grading-rubric.md` — severity → grade computation
- `.agents/aid/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
- `.agents/agents/aid-reviewer/` — the reviewer agent definition
