...
Worst-issue dominates the grade (per `.agents/aid/templates/grading-rubric.md`).
...
Per `.agents/aid/templates/grading-rubric.md`, the grade is COMPUTED from the severity
