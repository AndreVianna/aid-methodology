...
into one auto-generated file. See .agents/aid/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .agents/aid/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .agents/aid/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .agents/aid/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.agents/aid/scripts/kb/build-metrics.sh\`.*"
