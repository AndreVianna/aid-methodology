...
<!-- AUTO-GENERATED $TS by .agents/scripts/kb/build-kb-index.sh -->
<!-- DO NOT EDIT — regenerate with: bash .agents/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .agents/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md\`.*"
