...
**4a. Create `delivery-NNN/SPEC.md`** (seed from `.agents/aid/templates/delivery-spec-template.md`):
...
**4b. Create `delivery-NNN/STATE.md`** (seed from `.agents/aid/templates/delivery-state-template.md`):
