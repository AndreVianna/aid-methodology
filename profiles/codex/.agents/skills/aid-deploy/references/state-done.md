...
```
bash .agents/scripts/execute/writeback-state.sh --pipeline --field Lifecycle --value Completed
bash .agents/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value none
