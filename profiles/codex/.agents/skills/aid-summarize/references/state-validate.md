...
`.aid/.temp/review-pending/summarize.md` (per `.agents/templates/reviewer-ledger-schema.md`):
...
```bash
bash .agents/scripts/grade.sh --explain .aid/.temp/review-pending/summarize.md
```
