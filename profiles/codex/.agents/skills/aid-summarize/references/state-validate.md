...
`.aid/.temp/review-pending/summarize.md` (per `.agents/aid/templates/reviewer-ledger-schema.md`):
...
```bash
bash .agents/aid/scripts/grade.sh --explain .aid/.temp/review-pending/summarize.md
```
