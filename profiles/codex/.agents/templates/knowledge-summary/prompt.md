...
- POSIX: `.agents/scripts/summarize/concatenate.sh part1.html mermaid.min.js part2.html OUTPUT`
- Windows: `.agents/scripts/summarize/concatenate.ps1 -Part1 ... -Mermaid ... -Part2 ... -Output ...`
