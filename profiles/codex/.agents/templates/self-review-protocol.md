...
`bash .agents/scripts/...`." Don't just fix the cited file. Grep:
...
- `.agents/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.agents/templates/subagent-heartbeat-protocol.md` — the heartbeat
