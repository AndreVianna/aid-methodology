...
All three builders are registered in `.agents/templates/generated-files.txt`
...
- `.agents/agents/discovery-reviewer/AGENT.md` — adversarial review (semantic + frontmatter + spot-check; the sole KB-quality enforcer)
- `.agents/scripts/kb/build-metrics.sh` — T3 fact generator
- `.agents/scripts/kb/build-kb-index.sh` — INDEX.md generator
- `.agents/scripts/kb/build-project-index.sh` — project-index.md generator
- `.agents/templates/generated-files.txt` — registry of all generated files + build commands
- `.agents/templates/knowledge-base/*.md` — KB doc templates pre-filled with frontmatter
