...
into one auto-generated file. See .codex/aid/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .codex/aid/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .codex/aid/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .codex/aid/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.codex/aid/scripts/kb/build-metrics.sh\`.*"
