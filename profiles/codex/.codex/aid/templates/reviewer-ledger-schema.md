...
| 5 | `Doc` | yes | Affected file path (relative to repo root). Examples: `foo.md`, `.codex/aid/scripts/bar.sh`, `tests/canonical/baz.sh`. For doc-wide issues with no specific file, use `—`. |
