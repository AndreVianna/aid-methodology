...
speculatively. See `.codex/aid/templates/subagent-heartbeat-protocol.md` for
the full contract.
...
`.codex/aid/templates/subagent-heartbeat-protocol.md` §Cooperative
...
Apply regardless of task size. See `.codex/aid/templates/self-review-protocol.md`
