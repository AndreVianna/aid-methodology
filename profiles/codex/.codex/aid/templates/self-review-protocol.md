...
`bash .codex/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.codex/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.codex/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
