...
`.codex/aid/templates/rough-time-hints.md`. On completion, append the dispatch row
...
`.codex/aid/templates/shortcut-scaffolding/{family}.md`, where `{family}` is the
...
hand-authored, single-shot `.codex/skills/aid-query-kb/SKILL.md`, not a generated
...
- `## Execution Graph`: copy the template's scaffold as-is for now (`task-001` /
  ...
  `.codex/skills/aid-detail/references/execution-graph-generation.md`). Do not
