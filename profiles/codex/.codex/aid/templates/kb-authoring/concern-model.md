...
`.codex/aid/templates/kb-authoring/domain-doc-matrix.md`); "did we cover everything?"
...
is **not** a seed doc and has no template under `.codex/aid/templates/knowledge-base/`,
