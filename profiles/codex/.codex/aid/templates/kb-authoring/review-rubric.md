...
[`.codex/aid/templates/grading-rubric.md#severity-scale`](.codex/aid/templates/grading-rubric.md#severity-scale). Modality sets the band; blast radius
...
Per `.codex/aid/templates/grading-rubric.md`, the grade is COMPUTED from the severity
