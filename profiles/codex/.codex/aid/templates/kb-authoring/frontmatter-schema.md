...
Name of the build script (relative to `.codex/aid/scripts/` or as a
project-relative path). Listed in `.codex/aid/templates/generated-files.txt` registry.
...
- Each entry is one of:
  - A **repo-relative path** (`src/foo.ts`, `.codex/aid/scripts/kb/`)
  - A **glob** (`src/parsers/*.py`, `.codex/aid/templates/*.md`)
...
```yaml
sources:
  - .codex/aid/templates/knowledge-base/
