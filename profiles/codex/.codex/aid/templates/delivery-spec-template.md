...
{Brief listing of tasks that belong to this delivery. Each task has a full SPEC.md at
tasks/task-NNN/SPEC.md. This section provides a navigational overview only.}
...
in the gate criteria. Keep brief; detailed design belongs in task SPEC.md files.}
