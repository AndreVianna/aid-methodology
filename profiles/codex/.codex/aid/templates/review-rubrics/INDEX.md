...
[`.codex/aid/templates/grading-rubric.md#severity-scale`](../grading-rubric.md#severity-scale).
...
- [`.codex/aid/templates/reviewer-ledger-schema.md`](../reviewer-ledger-schema.md) — the ledger
  the `Rule` column lives in
- [`.codex/aid/templates/kb-authoring/review-rubric.md`](../kb-authoring/review-rubric.md) — the
