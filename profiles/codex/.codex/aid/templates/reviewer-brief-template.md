...
RULE SET: {{RULE_SET}} -- resolve via .codex/aid/templates/review-rubrics/INDEX.md
  Severity is a LOOKUP against the violated rule's anchor, per
  .codex/aid/templates/grading-rubric.md#severity-scale. Do not invent a band.
...
MISSING CRITERIA:
  ...
  see .codex/aid/templates/criteria-gap-protocol.md. Do NOT invent a criterion,
