...
- `.codex/aid/templates/shortcut-scaffolding/create.md` -- the artifact
  matrix (SPEC sections + task breakdown) this file inherits by reference
- `.codex/aid/templates/shortcut-scaffolding/analyze-report.md § aid-review /
...
- `.aid/knowledge/artifact-schemas.md § Task DETAIL.md` -- the one-type-per-task
  contract
- `.codex/skills/aid-execute/references/task-type-rules.md ## REFACTOR` --
