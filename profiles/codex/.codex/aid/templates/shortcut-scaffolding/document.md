...
- `.codex/skills/aid-create-document/SKILL.md` (+ `aid-change-document`) -- the
...
- `.codex/aid/templates/shortcut-scaffolding/analyze-report.md § Ownership
...
- `.codex/skills/aid-execute/references/task-type-rules.md ## DOCUMENT` -- the
