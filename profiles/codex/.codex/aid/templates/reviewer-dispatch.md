...
This document lives in `.codex/aid/templates/` and is a **skill-bundle artifact**, not a KB document.
...
- `.codex/agents/aid-reviewer/` — the deep reviewer; `.codex/agents/aid-screener/` — the screener
