...
Calibration is shared substrate for the full-path interview's own adaptive loop;
full-vs-lite routing is not this skill's concern. The backbone-first and
walking-skeleton moves (Gap rank 2 for scope-size
