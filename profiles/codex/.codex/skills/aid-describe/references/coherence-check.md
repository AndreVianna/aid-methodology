...
**Cross-references.**
- `.codex/skills/aid-describe/references/move-playbook.md` -- Move 8
...
- `.codex/skills/aid-describe/references/elicitation-engine.md` -- gap rank 1
...
- `.codex/skills/aid-describe/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.codex/skills/aid-describe/references/advisor-stance.md`). Every surfaced conflict
