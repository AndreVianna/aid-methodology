...
`.codex/skills/aid-describe/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.codex/skills/aid-describe/references/elicitation-engine.md` -- the engine driver
...
`.codex/skills/aid-describe/references/advisor-stance.md`.
...
`.codex/skills/aid-describe/references/elicitation-engine.md` reads this table. The
...
See `.codex/skills/aid-describe/references/elicitation-engine.md` for the full
