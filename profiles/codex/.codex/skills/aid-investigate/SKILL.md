...
description: >
  ...
  .codex/skills/aid-research/SKILL.md.
...
`/aid-investigate` is the alias of **`/aid-research`** (`.codex/skills/aid-research/SKILL.md`),
...
is defined exclusively by `.codex/skills/aid-research/SKILL.md`. Read that file and
