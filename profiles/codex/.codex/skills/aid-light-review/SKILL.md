...
Read the invocation manifest (`.codex/aid/templates/reviewer-brief-template.md` § invocation
...
- `.codex/agents/aid-screener/AGENT.md` — the agent dispatched here
- `.codex/aid/templates/reviewer-brief-template.md` — the invocation manifest
