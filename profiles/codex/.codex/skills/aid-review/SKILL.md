...
(`.codex/aid/templates/work-initiation-gate.md`): run
...
3. **Gate, then grade the review:** `bash .codex/aid/scripts/review/check-gaps.sh --ledger <verify-ledger>` (exit 1 = an open criteria gap; do not grade), then `bash .codex/aid/scripts/grade.sh --explain <verify-ledger>`.
