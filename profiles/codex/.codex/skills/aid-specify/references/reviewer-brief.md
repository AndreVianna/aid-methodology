...
`aid-reviewer` sub-agent. Follows `.codex/aid/templates/reviewer-dispatch.md`.
...
DELIVERABLES:
  ...
  - Grade: per .codex/aid/scripts/grade.sh; minimum resolved via
    `bash .codex/aid/scripts/config/read-setting.sh --skill specify --key minimum_grade --default A`
