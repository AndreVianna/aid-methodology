...
3. **Resolve the destination by concern, not filename.** This skill binds concern **C1**
   (build & shape, `.codex/aid/templates/kb-authoring/concern-model.md`). The seed's
   ...
   `.codex/aid/templates/kb-authoring/domain-doc-matrix.md`, and confirm with the user.
