...
`.codex/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.codex/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`.codex/skills/aid-interview/references/advisor-stance.md`.
...
`.codex/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `.codex/skills/aid-interview/references/elicitation-engine.md` for the full
