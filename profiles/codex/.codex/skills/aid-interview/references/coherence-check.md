...
**Cross-references.**
- `.codex/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `.codex/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `.codex/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.codex/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
