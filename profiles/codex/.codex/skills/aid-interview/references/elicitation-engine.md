...
**Cross-references.**
- `.codex/skills/aid-interview/references/move-playbook.md` -- the ten moves and
  the gap-type -> move firing table that Step 3 (MOVE SELECTION) reads each turn.
- `.codex/skills/aid-interview/references/calibration.md` -- the continuous
  read+ask design, the `Unknown | Expert | Mixed | Novice` state, and the
  depth-shaping rules that Step 4 (CALIBRATION SHAPING) applies.
- `.codex/skills/aid-interview/references/advisor-stance.md` -- the NFR-7
...
| Move playbook | `.codex/skills/aid-interview/references/move-playbook.md` |
| Calibration state | `.codex/skills/aid-interview/references/calibration.md` |
| NFR-7 invariant | `.codex/skills/aid-interview/references/advisor-stance.md` |
...
Delegate to `.codex/skills/aid-interview/references/move-playbook.md`. Read the
...
Delegate to `.codex/skills/aid-interview/references/calibration.md`. Read the
...
Delegate to `.codex/skills/aid-interview/references/advisor-stance.md`:
