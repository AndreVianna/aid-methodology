...
(quality & testing, `.codex/aid/templates/kb-authoring/concern-model.md`), never a
hardcoded filename. Resolve C6 against `.aid/settings.yml` `knowledge.doc_set`, falling
back to the C6 row of `.codex/aid/templates/kb-authoring/domain-doc-matrix.md`, and
