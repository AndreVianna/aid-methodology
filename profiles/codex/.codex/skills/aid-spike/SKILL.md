...
description: >
  ...
  behavior is defined by .codex/skills/aid-research/SKILL.md.
...
`/aid-spike` is the alias of **`/aid-research`** (`.codex/skills/aid-research/SKILL.md`),
...
`.codex/skills/aid-research/SKILL.md` -- including the **feasibility-spike escalation**
