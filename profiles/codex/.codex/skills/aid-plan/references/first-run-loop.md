...
**4a. Create `delivery-NNN/SPEC.md`** (seed from `.codex/aid/templates/delivery-spec-template.md`):
...
**4b. Create `delivery-NNN/STATE.md`** (seed from `.codex/aid/templates/delivery-state-template.md`):
