...
`.codex/aid/templates/requirements/requirements-template.md § Verifiable Acceptance Criteria`):
...
Seeded from `.codex/aid/templates/delivery-state-template.yml` with:
