...
```bash
KB_STAGE=$(bash .codex/aid/scripts/housekeep/housekeep-state.sh \
...
`.codex/aid/scripts/config/read-setting.sh --skill summary --key minimum_grade
...
approved. Do NOT edit anything in `.codex/skills/aid-summarize/` — the skill
runs unmodified.
...
(`.codex/skills/aid-summarize/SKILL.md:60`).
