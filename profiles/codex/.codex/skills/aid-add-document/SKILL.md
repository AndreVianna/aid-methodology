...
(`.codex/skills/aid-create-document/SKILL.md`), per the alias-is-a-full-directory
...
`.codex/skills/aid-create-document/SKILL.md`. Read that file and execute it exactly
