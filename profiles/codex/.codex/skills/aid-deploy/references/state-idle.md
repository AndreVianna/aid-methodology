...
bash .codex/aid/scripts/execute/writeback-state.sh --pipeline --field Phase --value Deploy
bash .codex/aid/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value aid-deploy
