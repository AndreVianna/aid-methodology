...
```
bash .codex/aid/scripts/execute/writeback-state.sh --pipeline --field Lifecycle --value Completed
bash .codex/aid/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value none
