...
(technology, `.codex/aid/templates/kb-authoring/concern-model.md`), never a hardcoded
filename. Resolve C0 against `.aid/settings.yml` `knowledge.doc_set`, falling back to the
C0 row of `.codex/aid/templates/kb-authoring/domain-doc-matrix.md`, and **confirm the
