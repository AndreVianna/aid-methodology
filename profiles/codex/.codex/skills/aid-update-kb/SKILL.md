...
**not** use `.codex/aid/scripts/works/worktree-lifecycle.sh` or
`.codex/aid/templates/work-initiation-gate.md` -- both hard-validate a
...
of `.codex/aid/templates/worktree-lifecycle.md § Step 2` only.
...
1. **Look up ETA** in `.codex/aid/templates/rough-time-hints.md` for the
...
- `.codex/aid/templates/long-wait-protocol.md` -- full L2 spec
- `.codex/aid/templates/subagent-heartbeat-protocol.md` -- full L3 spec
- `.codex/aid/templates/rough-time-hints.md` -- current measured ETAs
...
> `bash .codex/aid/scripts/config/read-setting.sh --skill update-kb --key minimum_grade --default A`
...
> `.codex/aid/templates/state-machine-chaining.md`. Mechanical states
