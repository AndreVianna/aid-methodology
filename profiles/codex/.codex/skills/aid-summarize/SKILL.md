...
- `.codex/aid/templates/knowledge-summary/mermaid-init.js` — Mermaid theme variables for both modes
- `.codex/aid/templates/knowledge-summary/mermaid-examples.md` — one valid example per diagram type + pitfalls table
- `.codex/aid/templates/knowledge-summary/section-templates/{profile}.md` — section structure per project type
- `.codex/aid/templates/knowledge-summary/accessibility-checklist.md` — WCAG AA targets, focus trap pattern
- `.codex/aid/templates/knowledge-summary/grading-rubric.md` — two-grade rubric (Machine + Human), per-profile diagram counts
- `.codex/aid/templates/knowledge-summary/html-skeleton.html` — doctype, head, semantic landmarks, noscript
