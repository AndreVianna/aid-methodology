...
description: >
  ...
  of its own -- its full behavior is defined by .codex/skills/aid-review/SKILL.md.
...
`/aid-audit` is the alias of **`/aid-review`** (`.codex/skills/aid-review/SKILL.md`),
per the same alias-is-a-full-directory convention the shortcut catalog uses
(`.codex/aid/templates/shortcut-catalog.yml` Topology note: an alias is a full,
separate `.codex/skills/<name>/SKILL.md` directory, not a redirect the generator
...
and every constraint -- is defined exclusively by `.codex/skills/aid-review/SKILL.md`.
