...
description: >
  ...
  of its own -- its full behavior is defined by .agent/skills/aid-review/SKILL.md.
...
`/aid-audit` is the alias of **`/aid-review`** (`.agent/skills/aid-review/SKILL.md`),
per the same alias-is-a-full-directory convention the shortcut catalog uses
(`.agent/aid/templates/shortcut-catalog.yml` Topology note: an alias is a full,
separate `.agent/skills/<name>/SKILL.md` directory, not a redirect the generator
...
and every constraint -- is defined exclusively by `.agent/skills/aid-review/SKILL.md`.
