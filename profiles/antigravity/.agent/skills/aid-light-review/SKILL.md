...
Read the invocation manifest (`.agent/aid/templates/reviewer-brief-template.md` § invocation
...
- `.agent/agents/aid-screener/AGENT.md` — the agent dispatched here
- `.agent/aid/templates/reviewer-brief-template.md` — the invocation manifest
