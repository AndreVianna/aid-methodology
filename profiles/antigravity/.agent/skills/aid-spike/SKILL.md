...
description: >
  ...
  behavior is defined by .agent/skills/aid-research/SKILL.md.
...
`/aid-spike` is the alias of **`/aid-research`** (`.agent/skills/aid-research/SKILL.md`),
...
`.agent/skills/aid-research/SKILL.md` -- including the **feasibility-spike escalation**
