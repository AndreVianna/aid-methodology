...
**Cross-references.**
- `.agent/skills/aid-describe/references/move-playbook.md` -- Move 8
...
- `.agent/skills/aid-describe/references/elicitation-engine.md` -- gap rank 1
...
(`.agent/skills/aid-describe/references/advisor-stance.md`). Every surfaced conflict
