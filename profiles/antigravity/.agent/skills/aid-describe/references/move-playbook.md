...
`.agent/skills/aid-describe/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.agent/skills/aid-describe/references/elicitation-engine.md` -- the engine driver
...
`.agent/skills/aid-describe/references/advisor-stance.md`.
...
`.agent/skills/aid-describe/references/elicitation-engine.md` reads this table. The
...
See `.agent/skills/aid-describe/references/elicitation-engine.md` for the full
