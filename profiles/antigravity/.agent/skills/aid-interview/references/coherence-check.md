...
**Cross-references.**
- `.agent/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `.agent/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `.agent/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.agent/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
