...
`.agent/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.agent/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`.agent/skills/aid-interview/references/advisor-stance.md`.
...
`.agent/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `.agent/skills/aid-interview/references/elicitation-engine.md` for the full
