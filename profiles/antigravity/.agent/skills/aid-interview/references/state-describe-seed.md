...
(`.agent/skills/aid-discover/references/state-review.md` with `greenfield: true`).
...
- `.agent/skills/aid-discover/references/state-review.md` -- the review subsystem invoked at
...
- `.agent/skills/aid-discover/references/reviewer-brief.md` -- reviewer brief template; the
  `{{GREENFIELD_BLOCK}}` substitution ("`greenfield: true` case") must be populated.
- `.agent/skills/aid-discover/references/document-expectations.md` -- `## Greenfield Mode`
  block applies when `greenfield: true` (evidence substitution + as-built red flags relaxed +
  dimension floors retained).
- `.agent/aid/templates/kb-authoring/frontmatter-schema.md` -- `source: forward-authored` is
...
**Invoke `.agent/skills/aid-discover/references/state-review.md` with `greenfield: true`.**

**Reviewer brief (`.agent/skills/aid-discover/references/reviewer-brief.md`):**
