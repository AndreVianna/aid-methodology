...
Scan `.agent/recipes/` relative to the AID installation root (the same directory that
...
`.agent/recipes/` relative to the AID installation root, i.e. the same directory
