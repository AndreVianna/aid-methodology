...
description: >
  ...
  defined by .agent/skills/aid-create-document/SKILL.md.
...
(`.agent/skills/aid-create-document/SKILL.md`), per the alias-is-a-full-directory
convention the shortcut catalog uses (an alias is a full, separate
`.agent/skills/<name>/SKILL.md` directory, not a redirect the generator resolves).
...
`.agent/skills/aid-create-document/SKILL.md`. Read that file and execute it exactly
