...
Run `.agent/aid/scripts/summarize/emit-summary-findings.sh .aid/knowledge/kb.html --ledger .aid/.temp/review-pending/summarize.md`. It orchestrates the machine-verifiable checks only.
