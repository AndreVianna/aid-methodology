...
```bash
KB_STAGE=$(bash .agent/aid/scripts/housekeep/housekeep-state.sh \
...
`.agent/aid/scripts/config/read-setting.sh --skill summary --key minimum_grade
...
approved. Do NOT edit anything in `.agent/skills/aid-summarize/` — the skill
runs unmodified.
...
(`.agent/skills/aid-summarize/SKILL.md:60`).
