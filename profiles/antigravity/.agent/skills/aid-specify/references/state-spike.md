...
bash .agent/aid/scripts/execute/writeback-state.sh --pipeline --field "Pause Reason" --value "Spike needed — awaiting investigation results before /aid-specify can continue"
