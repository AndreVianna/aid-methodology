...
```bash
bash .agent/scripts/grade.sh --explain .aid/.temp/review-pending/specify-<feature>.md
```

Compare to minimum grade from `bash .agent/scripts/config/read-setting.sh --skill specify --key minimum_grade --default A`.
