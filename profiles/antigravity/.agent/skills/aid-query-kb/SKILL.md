...
4. Compose the answer with inline citations:
   ...
   - File path: cite as `.agent/skills/aid-query-kb/SKILL.md`.
...
`.agent/aid/templates/connectors/consumption-protocol.md` (scan `.aid/connectors/INDEX.md`;
...
- <citation 2>  (e.g., `.agent/skills/aid-housekeep/SKILL.md`)
