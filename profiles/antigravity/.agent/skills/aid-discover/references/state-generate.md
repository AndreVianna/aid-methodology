...
```bash
bash .agent/aid/scripts/kb/kb-citation-lint.sh --root .aid/knowledge
```
...
```bash
bash .agent/aid/scripts/kb/lint-frontmatter.sh --root .aid/knowledge --fail-on-skip
```
