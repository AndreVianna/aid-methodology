...
```
bash .agent/scripts/execute/writeback-state.sh --pipeline --field Lifecycle --value Completed
bash .agent/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value none
