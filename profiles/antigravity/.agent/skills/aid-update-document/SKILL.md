...
description: >
  ...
  .agent/skills/aid-change-document/SKILL.md.
...
(`.agent/skills/aid-change-document/SKILL.md`), per the alias-is-a-full-directory
...
constraint -- is defined exclusively by `.agent/skills/aid-change-document/SKILL.md`.
