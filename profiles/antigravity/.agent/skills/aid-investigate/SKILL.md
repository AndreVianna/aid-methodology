...
description: >
  ...
  .agent/skills/aid-research/SKILL.md.
...
`/aid-investigate` is the alias of **`/aid-research`** (`.agent/skills/aid-research/SKILL.md`),
...
is defined exclusively by `.agent/skills/aid-research/SKILL.md`. Read that file and
