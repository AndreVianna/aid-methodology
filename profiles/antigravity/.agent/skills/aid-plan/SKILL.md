...
`.agent/aid/templates/requirements/requirements-template.md § Verifiable Acceptance Criteria`):
...
Seeded from `.agent/aid/templates/delivery-state-template.yml` with:
