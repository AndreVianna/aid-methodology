...
**4a. Create `delivery-NNN/SPEC.md`** (seed from `.agent/aid/templates/delivery-spec-template.md`):
...
**4b. Create `delivery-NNN/STATE.md`** (seed from `.agent/aid/templates/delivery-state-template.md`):
