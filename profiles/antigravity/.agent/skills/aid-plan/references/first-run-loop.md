...
**4a. Create `deliveries/delivery-NNN/BLUEPRINT.md`** (seed from `.agent/aid/templates/delivery-blueprint-template.md`):
...
**4b. Create `deliveries/delivery-NNN/STATE.md`** (seed from `.agent/aid/templates/delivery-state-template.md`):
...
```bash
bash .agent/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/plan.md   # exit 1 = an open criteria gap; do NOT grade
