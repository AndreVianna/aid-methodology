...
(`.agent/skills/aid-prototype/SKILL.md`) -- not an alias: it is its own catalog row
...
**This file has no logic of its own.** Execute `.agent/skills/aid-prototype/SKILL.md`
