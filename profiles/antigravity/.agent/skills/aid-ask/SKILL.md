...
description: >
  ...
  .agent/skills/aid-query-kb/SKILL.md, which this skill delegates to.
...
(`.agent/skills/aid-query-kb/SKILL.md`) -- `aid-query-kb` was renamed FROM
...
(`.agent/aid/templates/shortcut-catalog.yml`'s Topology note: an alias is a
full, separate `.agent/skills/<name>/SKILL.md` directory -- not a redirect
...
exclusively by `.agent/skills/aid-query-kb/SKILL.md`. Read that file and
...
Same as `aid-query-kb`'s own Pre-flight (`.agent/skills/aid-query-kb/SKILL.md
...
Delegate to `.agent/skills/aid-query-kb/SKILL.md § Execution: answer the
