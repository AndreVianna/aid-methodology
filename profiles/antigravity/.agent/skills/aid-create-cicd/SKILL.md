...
3. **Resolve the destination by concern, not filename.** This skill binds concern **C8**
   (shipping & operation, `.agent/aid/templates/kb-authoring/concern-model.md`). The seed's
   ...
   `.agent/aid/templates/kb-authoring/domain-doc-matrix.md`, and confirm with the user. An
