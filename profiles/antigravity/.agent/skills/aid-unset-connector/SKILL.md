...
(`.agent/skills/aid-set-connector/SKILL.md`), and shares its `reconcile.md` single-stem plumbing.
...
`aid-set-connector` use (`.agent/aid/templates/kb-authoring/principles.md` P7 "Exception
