...
`.agent/aid/templates/rough-time-hints.md`. On completion, emit the closing `✓ ...
...
Copy `.agent/aid/templates/work-state-template.yml` to
...
`.agent/aid/scripts/execute/derive-waves.sh --from-tasks <work-dir>`, which the
