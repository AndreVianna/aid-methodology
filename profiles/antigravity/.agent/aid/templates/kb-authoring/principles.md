...
the final state. Refresh is driven by `.agent/aid/templates/generated-files.txt`
registry.
...
- **Generated content** (`.aid/generated/*`) — persistent build artifacts produced by
  ...
  ```html
  <!-- AUTO-GENERATED 2026-05-27T12:34:56Z by build-kb-index.sh — DO NOT EDIT — regenerate with `bash .agent/aid/scripts/kb/build-kb-index.sh` -->
  ```
...
- **P10 + P6** — dual-audience classification is enforced via the frontmatter fields
  ...
  `.agent/skills/aid-discover/references/state-review.md`) checks compliance.
