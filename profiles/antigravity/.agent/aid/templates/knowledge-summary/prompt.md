...
`.agent/aid/templates/knowledge-summary/section-templates/bespoke-components.md`:
...
bash .agent/aid/scripts/summarize/assemble.sh --output .aid/knowledge/kb.html
```
