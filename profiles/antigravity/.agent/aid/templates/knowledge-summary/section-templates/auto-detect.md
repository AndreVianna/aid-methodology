...
| Multiple agent definitions exist (`.agent/agents/` or `.agents/` or equivalent with ≥3 `AGENT.md` files) | +3 | `find canonical/agents -name "AGENT.md" \| wc -l` (or equivalent path); threshold ≥ 3 |
