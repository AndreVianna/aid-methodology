...
- `.agent/aid/templates/shortcut-scaffolding/create.md` -- the artifact
  matrix (SPEC sections + task breakdown) this file inherits by reference
- `.agent/aid/templates/shortcut-scaffolding/analyze-report.md § aid-review /
  § aid-research` -- where the decision to remove/deprecate/migrate gets
  assessed before this file's verbs act on it
- `.agent/aid/templates/shortcut-engine.md § Family Scaffolding Consult` --
...
- `.agent/skills/aid-execute/references/task-type-rules.md ## MIGRATE /
...
- `.aid/knowledge/artifact-schemas.md § Task DETAIL.md` -- the one-type-per-task
  contract
- `.agent/skills/aid-execute/references/task-type-rules.md ## REFACTOR` --
