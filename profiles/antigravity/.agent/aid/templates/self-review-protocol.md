...
`bash .agent/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.agent/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.agent/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
