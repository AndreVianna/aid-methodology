...
```bash
bash .agent/aid/scripts/review/check-gaps.sh --ledger <path>   # 0 clean, 1 open criteria gap
bash .agent/aid/scripts/grade.sh --explain <path>              # only reachable on exit 0
```
