...
>   `.agent/skills/aid-discover/references/state-elicit.md` Step E2, once per ELICIT cycle,
...
>   `.agent/skills/aid-set-connector/SKILL.md` (upsert) and
>   `.agent/skills/aid-unset-connector/SKILL.md` (remove) — work-004-connector-consumption's
