...
This document lives in `.agent/aid/templates/` and is a **skill-bundle artifact**, not a KB document.
...
- `.agent/agents/aid-reviewer/` — the deep reviewer; `.agent/agents/aid-screener/` — the screener
