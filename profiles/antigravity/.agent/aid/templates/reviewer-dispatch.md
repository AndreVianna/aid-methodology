...
DELIVERABLES:
  - Findings ledger at `.aid/.temp/review-pending/<scope>.md` per
    `.agent/aid/templates/reviewer-ledger-schema.md`
...
wildcards beyond the artifact set (e.g., `.agent/aid/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .agent/aid/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .agent/aid/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.agent/aid/templates/grading-rubric.md`
...
`.agent/skills/<skill>/references/reviewer-brief.md`. Six per-skill briefs
...
```
ARTIFACTS UNDER REVIEW:
  - .agent/aid/templates/kb-authoring/README.md
  - .agent/aid/templates/kb-authoring/principles.md
  - .agent/aid/templates/kb-authoring/tier-model.md
  - .agent/aid/templates/kb-authoring/frontmatter-schema.md
  - .agent/aid/templates/kb-authoring/review-rubric.md
  - .agent/aid/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .agent/aid/templates/generated-files.txt
  - .agent/aid/scripts/kb/build-metrics.sh
  - .agent/aid/scripts/kb/build-kb-index.sh
  - .agent/aid/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .agent/aid/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
This doc lives in `.agent/aid/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.agent/aid/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.agent/aid/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.agent/aid/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.agent/aid/templates/grading-rubric.md` — severity → grade computation
- `.agent/aid/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
- `.agent/agents/aid-reviewer/` — the reviewer agent definition
