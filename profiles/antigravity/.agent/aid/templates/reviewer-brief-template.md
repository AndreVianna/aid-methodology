...
RULE SET: {{RULE_SET}} -- resolve via .agent/aid/templates/review-rubrics/INDEX.md
  Severity is a LOOKUP against the violated rule's anchor, per
  .agent/aid/templates/grading-rubric.md#severity-scale. Do not invent a band.
...
MISSING CRITERIA:
  ...
  see .agent/aid/templates/criteria-gap-protocol.md. Do NOT invent a criterion,
