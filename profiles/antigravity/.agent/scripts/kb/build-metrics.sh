...
into one auto-generated file. See .agent/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .agent/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .agent/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .agent/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.agent/scripts/kb/build-metrics.sh\`.*"
