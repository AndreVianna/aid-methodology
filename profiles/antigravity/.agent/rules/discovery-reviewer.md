...
Your output is a single markdown file at `.aid/.temp/review-pending/discovery.md` containing **exactly one markdown table** per the schema at `.agent/templates/reviewer-ledger-schema.md`.
...
|---|---|---|---|---|---|---|
| 1 | [HIGH] | Pending | architecture.md | 42 | module count wrong: doc claims 7, disk shows 9 | `ls .agent/skills/ | wc -l` = 9 (doc claims 7) |
