---
trigger: always_on
description: Maps modules, mines coding conventions from actual code, and extracts data schemas. Produces module-map.md, coding-standards.md, and schemas.md for the Knowledge Base.
---
...
## What You Do
- Map every module: purpose, dependencies, relative size, test coverage
...
- Produce `.aid/knowledge/module-map.md`, `.aid/knowledge/coding-standards.md`, `.aid/knowledge/schemas.md`
