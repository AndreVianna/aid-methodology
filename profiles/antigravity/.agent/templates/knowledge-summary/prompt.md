...
- POSIX: `.agent/scripts/summarize/assemble-3part.sh part1.html mermaid.min.js part2.html OUTPUT`
- Windows: `.agent/scripts/summarize/assemble-3part.ps1 -Part1 ... -Mermaid ... -Part2 ... -Output ...`
