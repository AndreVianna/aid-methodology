...
DELIVERABLES:
  - Findings ledger at `.aid/.temp/review-pending/<scope>.md` per
    `.agent/templates/reviewer-ledger-schema.md`
...
wildcards beyond the artifact set (e.g., `.agent/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .agent/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .agent/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.agent/templates/grading-rubric.md`
...
```
ARTIFACTS UNDER REVIEW:
  - .agent/templates/kb-authoring/README.md
  - .agent/templates/kb-authoring/principles.md
  - .agent/templates/kb-authoring/tier-model.md
  - .agent/templates/kb-authoring/frontmatter-schema.md
  - .agent/templates/kb-authoring/review-rubric.md
  - .agent/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .agent/templates/generated-files.txt
  - .agent/scripts/kb/build-metrics.sh
  - .agent/scripts/kb/build-kb-index.sh
  - .agent/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .agent/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
This doc lives in `.agent/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.agent/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.agent/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.agent/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.agent/templates/grading-rubric.md` — severity → grade computation
- `.agent/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
