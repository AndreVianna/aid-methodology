...
`bash .agent/scripts/...`." Don't just fix the cited file. Grep:
...
- `.agent/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.agent/templates/subagent-heartbeat-protocol.md` — the heartbeat
