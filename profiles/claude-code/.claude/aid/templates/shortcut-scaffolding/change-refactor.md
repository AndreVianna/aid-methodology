...
- `.claude/aid/templates/shortcut-scaffolding/create.md` -- the artifact
  matrix (SPEC sections + task breakdown) this file inherits by reference
- `.claude/aid/templates/shortcut-scaffolding/analyze-report.md § aid-review /
...
- `.claude/skills/aid-execute/references/task-type-rules.md ## MIGRATE /
...
- `.aid/knowledge/artifact-schemas.md § Task DETAIL.md` -- the one-type-per-task
  contract
- `.claude/skills/aid-execute/references/task-type-rules.md ## REFACTOR` --
