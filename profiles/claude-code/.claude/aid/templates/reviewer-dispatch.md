...
This document lives in `.claude/aid/templates/` and is a **skill-bundle artifact**, not a KB document.
...
- `.claude/agents/aid-reviewer/` — the deep reviewer; `.claude/agents/aid-screener/` — the screener
