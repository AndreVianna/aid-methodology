...
The skill's `VALIDATE` state runs `.claude/aid/scripts/grade.sh` against the generated
...
```
$ bash .claude/aid/scripts/grade.sh .aid/knowledge/knowledge-summary.html
