...
<!-- OPTIONAL `ticket_ref` -- e.g. `jira:PROJ-123`; links this feature to an external tracker
     ...
     contract: `.claude/aid/templates/connectors/consumption-protocol.md`. This is a SPEC body
...
`.claude/aid/templates/requirements/requirements-template.md § Verifiable
