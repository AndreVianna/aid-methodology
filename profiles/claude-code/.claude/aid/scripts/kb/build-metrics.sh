...
into one auto-generated file. See .claude/aid/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .claude/aid/templates/kb-authoring/tier-model.md):
...
<!-- DO NOT EDIT — regenerate with: bash .claude/aid/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.claude/aid/scripts/kb/build-metrics.sh\`.*"
