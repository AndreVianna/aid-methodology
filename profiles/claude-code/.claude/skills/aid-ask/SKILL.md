...
description: >
  ...
  .claude/skills/aid-query-kb/SKILL.md, which this skill delegates to.
...
(`.claude/skills/aid-query-kb/SKILL.md`) -- `aid-query-kb` was renamed FROM
...
(`.claude/aid/templates/shortcut-catalog.yml`'s Topology note: an alias is a
full, separate `.claude/skills/<name>/SKILL.md` directory -- not a redirect
...
exclusively by `.claude/skills/aid-query-kb/SKILL.md`. Read that file and
...
Same as `aid-query-kb`'s own Pre-flight (`.claude/skills/aid-query-kb/SKILL.md
...
Delegate to `.claude/skills/aid-query-kb/SKILL.md § Execution: answer the
