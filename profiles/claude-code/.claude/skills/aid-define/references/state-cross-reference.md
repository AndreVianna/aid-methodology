...
- **Ledger lifecycle:** "Append new findings as rows with Status: Pending to
  ...
  `bash .claude/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/interview-<work>-cross-ref.md` (exit 1 = an open criteria gap; do not grade), then `bash .claude/aid/scripts/grade.sh .aid/.temp/review-pending/interview-<work>-cross-ref.md`
...
```bash
bash .claude/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/interview-<work>-cross-ref.md   # exit 1 = an open criteria gap; do NOT grade
