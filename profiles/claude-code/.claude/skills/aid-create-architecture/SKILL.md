...
3. **Resolve the destination by concern, not filename.** This skill binds concern **C1**
   (build & shape, `.claude/aid/templates/kb-authoring/concern-model.md`). The seed's
   ...
   `.claude/aid/templates/kb-authoring/domain-doc-matrix.md`, and confirm with the user.
