...
**Cross-references.**
- `.claude/skills/aid-describe/references/move-playbook.md` -- Move 8
...
- `.claude/skills/aid-describe/references/elicitation-engine.md` -- gap rank 1
...
- `.claude/skills/aid-describe/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.claude/skills/aid-describe/references/advisor-stance.md`). Every surfaced conflict
