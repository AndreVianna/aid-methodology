...
**Cross-references.**
- `.claude/skills/aid-describe/references/move-playbook.md` -- the ten moves and
  the gap-type -> move firing table that Step 3 (MOVE SELECTION) reads each turn.
- `.claude/skills/aid-describe/references/calibration.md` -- the continuous
...
| Move playbook | `.claude/skills/aid-describe/references/move-playbook.md` |
| Calibration state | `.claude/skills/aid-describe/references/calibration.md` |
| NFR-7 invariant | `.claude/skills/aid-describe/references/advisor-stance.md` |
...
Delegate to `.claude/skills/aid-describe/references/move-playbook.md`. Read the
...
Delegate to `.claude/skills/aid-describe/references/calibration.md`. Read the
...
Delegate to `.claude/skills/aid-describe/references/advisor-stance.md`:
...
`.claude/skills/aid-triage/SKILL.md`). It is a UX-shape consumer, not a three-parameter
