...
`.claude/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.claude/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`.claude/skills/aid-interview/references/advisor-stance.md`.
...
`.claude/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `.claude/skills/aid-interview/references/elicitation-engine.md` for the full
