...
**Cross-references.**
- `.claude/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `.claude/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `.claude/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.claude/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
