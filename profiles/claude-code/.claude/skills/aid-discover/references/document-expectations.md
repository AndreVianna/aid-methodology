...
> owning-table in `.claude/aid/templates/kb-authoring/concern-model.md`
...
skill under `.claude/skills/` reads backlog.md at tag time, so nothing a project installs
