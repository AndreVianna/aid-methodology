...
# (see .claude/templates/kb-authoring/frontmatter-schema.md).
#
# Per .claude/templates/kb-authoring/principles.md P3, this script runs LAST in
...
Per .claude/templates/kb-authoring/principles.md P3, this script runs LAST
...
<!-- AUTO-GENERATED $TS by .claude/scripts/kb/build-index.sh -->
<!-- DO NOT EDIT — regenerate with: bash .claude/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/generated/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .claude/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/generated/INDEX.md\`.*"
