...
<!-- DO NOT EDIT — regenerate with: bash .claude/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .claude/scripts/kb/build-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md\`.*"
