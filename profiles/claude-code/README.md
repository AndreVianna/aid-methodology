...
This gives you:
- `.claude/skills/aid-{phase}/SKILL.md` — Phase instructions in AgentSkills format (75 skills: 17 curated pipeline / on-demand / router skills plus the 58-row shortcut catalog's skills — 34 verb-first shortcut doorways + 24 hand-authored repurpose skills)
