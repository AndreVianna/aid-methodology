...
This gives you:
- `.claude/skills/aid-{phase}/SKILL.md` — Phase instructions in AgentSkills format (94 skills: 16 classic — 11 across five pipeline groups + 5 off-pipeline on-demand — plus /aid-triage, /aid-ask, and 76 verb-first shortcut skills)
