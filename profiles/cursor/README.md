...
This gives you:
- `.cursor/skills/aid-{phase}/SKILL.md` — Phase instructions in AgentSkills format (92 skills: 14 classic — 11 across five pipeline groups + 3 off-pipeline on-demand — plus /aid-triage, /aid-ask, and 76 verb-first shortcut skills)
