...
`.cursor/skills/aid-interview/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.cursor/skills/aid-interview/references/elicitation-engine.md` -- the engine driver
...
`.cursor/skills/aid-interview/references/advisor-stance.md`.
...
`.cursor/skills/aid-interview/references/elicitation-engine.md` reads this table. The
...
See `.cursor/skills/aid-interview/references/elicitation-engine.md` for the full
