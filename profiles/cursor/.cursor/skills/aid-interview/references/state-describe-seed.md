...
(`.cursor/skills/aid-discover/references/state-review.md` with `greenfield: true`).
...
- `.cursor/skills/aid-discover/references/state-review.md` -- the review subsystem invoked at
...
- `.cursor/skills/aid-discover/references/reviewer-brief.md` -- reviewer brief template; the
  `{{GREENFIELD_BLOCK}}` substitution ("`greenfield: true` case") must be populated.
- `.cursor/skills/aid-discover/references/document-expectations.md` -- `## Greenfield Mode`
  block applies when `greenfield: true` (evidence substitution + as-built red flags relaxed +
  dimension floors retained).
- `.cursor/aid/templates/kb-authoring/frontmatter-schema.md` -- `source: forward-authored` is
...
**Invoke `.cursor/skills/aid-discover/references/state-review.md` with `greenfield: true`.**

**Reviewer brief (`.cursor/skills/aid-discover/references/reviewer-brief.md`):**
