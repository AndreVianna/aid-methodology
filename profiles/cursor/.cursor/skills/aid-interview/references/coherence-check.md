...
**Cross-references.**
- `.cursor/skills/aid-interview/references/move-playbook.md` -- Move 8
...
- `.cursor/skills/aid-interview/references/elicitation-engine.md` -- gap rank 1
...
- `.cursor/skills/aid-interview/features/feature-003-greenfield-seed-authoring/SPEC.md`
...
(`.cursor/skills/aid-interview/references/advisor-stance.md`). Every surfaced conflict
