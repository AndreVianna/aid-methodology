...
- **`deliveries/delivery-NNN/tasks/task-NNN/DETAIL.md`** — the immutable task definition (6-section
  schema), seeded from `.cursor/aid/templates/task-detail-template.md`:
...
- **`deliveries/delivery-NNN/tasks/task-NNN/STATE.md`** — seeded from `.cursor/aid/templates/task-state-template.md`,
