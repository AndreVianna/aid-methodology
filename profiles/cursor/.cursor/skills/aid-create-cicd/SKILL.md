...
3. **Resolve the destination by concern, not filename.** This skill binds concern **C8**
   (shipping & operation, `.cursor/aid/templates/kb-authoring/concern-model.md`). The seed's
   ...
   `.cursor/aid/templates/kb-authoring/domain-doc-matrix.md`, and confirm with the user. An
