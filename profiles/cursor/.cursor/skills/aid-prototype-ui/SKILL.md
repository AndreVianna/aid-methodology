...
description: >
  ...
  by .cursor/skills/aid-prototype/SKILL.md, with "ui" as the prototype target.
...
(`.cursor/skills/aid-prototype/SKILL.md`) -- not an alias: it is its own catalog row
...
**This file has no logic of its own.** Execute `.cursor/skills/aid-prototype/SKILL.md`
