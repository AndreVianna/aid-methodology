...
Run `.cursor/scripts/summarize/summarize-preflight.sh` before any state. It verifies:
...
See `.cursor/templates/knowledge-summary/grading-rubric.md` for the complete rubric and grade boundaries.

---

## References

- `.cursor/templates/knowledge-summary/prompt.md` — agent guidance for the GENERATE step (long-form)
- `.cursor/templates/knowledge-summary/design-tokens.md` — color palette, typography, spacing
- `.cursor/templates/knowledge-summary/component-css.css` — full reusable CSS (inlined)
- `.cursor/templates/knowledge-summary/lightbox.js` — full reusable JS (theme, lightbox, scrollspy, a11y)
- `.cursor/templates/knowledge-summary/mermaid-init.js` — Mermaid theme variables for both modes
- `.cursor/templates/knowledge-summary/mermaid-examples.md` — one valid example per diagram type + pitfalls table
- `.cursor/templates/knowledge-summary/section-templates/{profile}.md` — section structure per project type
- `.cursor/templates/knowledge-summary/accessibility-checklist.md` — WCAG AA targets, focus trap pattern
- `.cursor/templates/knowledge-summary/grading-rubric.md` — two-grade rubric (Machine + Human), per-profile diagram counts
- `.cursor/templates/knowledge-summary/html-skeleton.html` — doctype, head, semantic landmarks, noscript
- `.cursor/scripts/summarize/grade-summary.sh` — orchestrates AUTO_POOL checks, reads `.manual-checklist.json` for MANUAL_POOL, prints Machine + Human + Overall grades
