...
(shipping & operation, `.cursor/aid/templates/kb-authoring/concern-model.md`), never a
hardcoded filename. Resolve C8 against `.aid/settings.yml` `knowledge.doc_set`, falling
back to the C8 row of `.cursor/aid/templates/kb-authoring/domain-doc-matrix.md`, and
