...
bash .cursor/aid/scripts/execute/writeback-state.sh --pipeline --field "Pause Reason" --value "Blocker pending — awaiting loopback resolution before /aid-specify can continue"
