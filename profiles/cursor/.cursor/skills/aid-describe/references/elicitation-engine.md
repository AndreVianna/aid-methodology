...
**Cross-references.**
- `.cursor/skills/aid-describe/references/move-playbook.md` -- the ten moves and
  the gap-type -> move firing table that Step 3 (MOVE SELECTION) reads each turn.
- `.cursor/skills/aid-describe/references/calibration.md` -- the continuous
  read+ask design, the `Unknown | Expert | Mixed | Novice` state, and the
  depth-shaping rules that Step 4 (CALIBRATION SHAPING) applies.
- `.cursor/skills/aid-describe/references/advisor-stance.md` -- the NFR-7
...
| Move playbook | `.cursor/skills/aid-describe/references/move-playbook.md` |
| Calibration state | `.cursor/skills/aid-describe/references/calibration.md` |
| NFR-7 invariant | `.cursor/skills/aid-describe/references/advisor-stance.md` |
...
Delegate to `.cursor/skills/aid-describe/references/move-playbook.md`. Read the
...
Delegate to `.cursor/skills/aid-describe/references/calibration.md`. Read the
...
Delegate to `.cursor/skills/aid-describe/references/advisor-stance.md`:
...
`.cursor/skills/aid-triage/SKILL.md`). It is a UX-shape consumer, not a three-parameter
