...
**Cross-references.**
- `.cursor/skills/aid-describe/references/move-playbook.md` -- Move 8
...
- `.cursor/skills/aid-describe/references/elicitation-engine.md` -- gap rank 1
...
(`.cursor/skills/aid-describe/references/advisor-stance.md`). Every surfaced conflict
