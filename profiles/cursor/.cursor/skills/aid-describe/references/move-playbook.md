...
`.cursor/skills/aid-describe/references/elicitation-engine.md`) keys on.
...
**Cross-references.**
- `.cursor/skills/aid-describe/references/elicitation-engine.md` -- the engine driver
...
`.cursor/skills/aid-describe/references/advisor-stance.md`.
...
`.cursor/skills/aid-describe/references/elicitation-engine.md` reads this table. The
...
See `.cursor/skills/aid-describe/references/elicitation-engine.md` for the full
