...
description: >
  ...
  .cursor/skills/aid-query-kb/SKILL.md, which this skill delegates to.
...
(`.cursor/skills/aid-query-kb/SKILL.md`) -- `aid-query-kb` was renamed FROM
...
(`.cursor/aid/templates/shortcut-catalog.yml`'s Topology note: an alias is a
full, separate `.cursor/skills/<name>/SKILL.md` directory -- not a redirect
...
exclusively by `.cursor/skills/aid-query-kb/SKILL.md`. Read that file and
...
Same as `aid-query-kb`'s own Pre-flight (`.cursor/skills/aid-query-kb/SKILL.md
...
Delegate to `.cursor/skills/aid-query-kb/SKILL.md § Execution: answer the
