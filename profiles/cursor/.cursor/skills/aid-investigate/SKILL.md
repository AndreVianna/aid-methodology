...
description: >
  ...
  .cursor/skills/aid-research/SKILL.md.
...
`/aid-investigate` is the alias of **`/aid-research`** (`.cursor/skills/aid-research/SKILL.md`),
...
is defined exclusively by `.cursor/skills/aid-research/SKILL.md`. Read that file and
