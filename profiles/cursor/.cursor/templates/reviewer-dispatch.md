...
DELIVERABLES:
  - Findings ledger at `.aid/.temp/review-pending/<scope>.md` per
    `.cursor/templates/reviewer-ledger-schema.md`
...
DELIVERABLES:
  ...
  - Format: per .cursor/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
- `.cursor/templates/self-review-protocol.md` — the flip side of this protocol
