...
`bash .cursor/scripts/...`." Don't just fix the cited file. Grep:
...
- `.cursor/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.cursor/templates/subagent-heartbeat-protocol.md` — the heartbeat
