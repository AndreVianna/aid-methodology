...
Your output is a single markdown file at `.aid/.temp/review-pending/<scope>.md` containing **exactly one markdown table** per the schema at `.cursor/templates/reviewer-ledger-schema.md`.
