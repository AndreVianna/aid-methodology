...
- `.cursor/skills/aid-prototype/SKILL.md` -- the hand-authored collapse body that
  reads this file for per-slot capture/detail guidance (work-005; `prototype` is no
  longer engine-consulted)
- `.cursor/aid/templates/shortcut-scaffolding/create.md` -- where the validated
...
- `.cursor/skills/aid-execute/references/task-type-rules.md ## DESIGN` -- the
