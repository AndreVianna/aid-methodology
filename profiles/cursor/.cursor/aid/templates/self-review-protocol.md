...
`bash .cursor/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.cursor/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.cursor/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
