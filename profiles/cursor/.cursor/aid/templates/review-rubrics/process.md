...
| `PRO-04` | A release artifact's version carriers agree | `release-tracking.md` — the section declaring the version carriers | MUST | mechanical | `bash .cursor/aid/scripts/release/check-version-sync.sh --expect <version>` | `Step 2` |
