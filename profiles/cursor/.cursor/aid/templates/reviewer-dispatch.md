...
```
RUBRIC:
  .cursor/aid/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .cursor/aid/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.cursor/aid/templates/grading-rubric.md`
...
```
ARTIFACTS UNDER REVIEW:
  - .cursor/aid/templates/kb-authoring/README.md
  - .cursor/aid/templates/kb-authoring/principles.md
  - .cursor/aid/templates/kb-authoring/tier-model.md
  - .cursor/aid/templates/kb-authoring/frontmatter-schema.md
  - .cursor/aid/templates/kb-authoring/review-rubric.md
  - .cursor/aid/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .cursor/aid/templates/generated-files.txt
  - .cursor/aid/scripts/kb/build-metrics.sh
  - .cursor/aid/scripts/kb/build-kb-index.sh
  - .cursor/aid/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .cursor/aid/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
- `.cursor/aid/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.cursor/aid/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.cursor/aid/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.cursor/aid/templates/grading-rubric.md` — severity → grade computation
- `.cursor/aid/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
