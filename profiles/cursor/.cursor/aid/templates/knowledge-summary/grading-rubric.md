...
The skill's `VALIDATE` state runs `.cursor/aid/scripts/grade.sh` against the generated
...
```
$ bash .cursor/aid/scripts/grade.sh .aid/knowledge/knowledge-summary.html
