...
Name of the build script (relative to `.cursor/aid/scripts/` or as a
project-relative path). Listed in `.cursor/aid/templates/generated-files.txt` registry.
...
- Each entry is one of:
  - A **repo-relative path** (`src/foo.ts`, `.cursor/aid/scripts/kb/`)
  - A **glob** (`src/parsers/*.py`, `.cursor/aid/templates/*.md`)
...
```yaml
sources:
  - .cursor/aid/templates/knowledge-base/
