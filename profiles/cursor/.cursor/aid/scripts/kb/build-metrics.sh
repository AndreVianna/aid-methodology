...
into one auto-generated file. See .cursor/aid/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .cursor/aid/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .cursor/aid/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .cursor/aid/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.cursor/aid/scripts/kb/build-metrics.sh\`.*"
