...
<!-- AUTO-GENERATED $TS by .cursor/aid/scripts/kb/build-kb-index.sh -->
<!-- DO NOT EDIT - regenerate with: bash .cursor/aid/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .cursor/aid/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md\`.*"
