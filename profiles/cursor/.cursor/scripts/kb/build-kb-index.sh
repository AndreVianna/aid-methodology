...
Per .cursor/templates/kb-authoring/principles.md P3, this script runs LAST
...
<!-- AUTO-GENERATED $TS by .cursor/scripts/kb/build-kb-index.sh -->
<!-- DO NOT EDIT — regenerate with: bash .cursor/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .cursor/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md\`.*"
