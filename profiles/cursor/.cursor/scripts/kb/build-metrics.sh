...
#
# Per .cursor/templates/kb-authoring/tier-model.md, T3 (Metric) facts are BANNED
...
into one auto-generated file. See .cursor/templates/kb-authoring/tier-model.md for
...
intent: |
  Aggregated numeric facts (T3 Metric tier per .cursor/templates/kb-authoring/tier-model.md):
...
<!-- AUTO-GENERATED $TS by .cursor/scripts/kb/build-metrics.sh -->
<!-- DO NOT EDIT — regenerate with: bash .cursor/scripts/kb/build-metrics.sh --root . --output .aid/generated/metrics.md -->
...
EOF
    ...
    echo "\`.cursor/scripts/kb/build-metrics.sh\`.*"
