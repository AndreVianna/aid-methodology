...
|------|------------------------|-------|-------|
| 2026-07-16 | Work created | -- | Shortcut scaffold by /aid-change-cli (INTAKE) |
| 2026-07-16 | CAPTURE complete -- REQUIREMENTS.md written | -- | /aid-change-cli CAPTURE |
| 2026-07-16 | SPEC complete -- SPEC.md written | -- | /aid-change-cli SPEC |
| 2026-07-16 | PLAN complete -- PLAN.md + BLUEPRINT.md written | -- | /aid-change-cli PLAN |
| 2026-07-16 | DETAIL complete -- 2 task(s) written | -- | /aid-change-cli DETAIL |
| 2026-07-16 | GATE Pass 1 (definition docs) cleared | A+ | /aid-change-cli GATE defn |
| 2026-07-16 | GATE Pass 2 (task set) cleared | A+ | /aid-change-cli GATE tasks |
| 2026-07-16 | Requirements refined -- remove disambiguation finalized (rules 1-4; rule 5 dropped) | -- | /aid-change-cli |
...
<!-- AUTHORED -- single-delivery FLATTENED works only (see ## Delivery Lifecycle note above).
     ...
     `.aid/{work}/delivery-001-issues.md`; see `.claude/aid/templates/delivery-issues.md`) and runs
