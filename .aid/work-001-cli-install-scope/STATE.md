...
| task-004 | Global provisioning Windows parity (%ProgramData%\aid) (ps1) | IMPLEMENT | d001 w3 | In Review | — | — | feature-002; ps1 twin: Invoke-AidProvisionSharedStateHome, %ProgramData%\aid shared / %LOCALAPPDATA%\aid user, install.ps1 admin hooks, register degrade twin; dev-verified (PARSE/ASCII/functional under pwsh); FORMAL aid-reviewer review PENDING (bug-prone — mirrors task-003 D+ twin) |
