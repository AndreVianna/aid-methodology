...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** tests/canonical/test-document-family-scaffold.sh added (121 assertions, all pass): contract (document.md CAPTURE/SPEC/DETAIL archetype shapes/Ownership) + catalog (8 G8 rows, DOCUMENT) + fixture-shape (decision ADR + runbook structures, halt pre-Execute).
