...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** tests/canonical/test-analyze-report-family-scaffold.sh added (81 assertions, all pass): contract (analyze-report.md CAPTURE/SPEC/DETAIL/Ownership) + catalog (2 G11 rows, RESEARCH/IMPLEMENT) + fixture-shape (aid-report RESEARCH + aid-show-dashboard IMPLEMENT w/ Telemetry, halt pre-Execute).
