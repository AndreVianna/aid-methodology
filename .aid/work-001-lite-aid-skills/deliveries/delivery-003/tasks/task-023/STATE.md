...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** catalog rows + document.md scaffolding landed; build-shortcut-skills.py --check OK (67); run_generator.py VERIFY PASS; dogfood resynced; catalog-dirs-parity 476/476 pass
