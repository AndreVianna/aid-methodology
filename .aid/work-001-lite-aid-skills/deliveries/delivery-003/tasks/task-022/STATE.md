...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** tests/canonical/test-prototype-family-scaffold.sh added (74 assertions, all pass): contract (prototype.md CAPTURE/SPEC/DETAIL/Ownership) + catalog (2 G3 rows, DESIGN) + fixture-shape (prototype-ui + bare prototype, halt pre-Execute).
