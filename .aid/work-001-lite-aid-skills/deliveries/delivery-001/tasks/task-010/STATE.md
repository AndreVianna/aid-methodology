...
- **State:** Done
- **Review:** self-verified: bash tests/canonical/test-catalog-dirs-parity.sh -- 14/14 passed
- **Elapsed:** engine/gate/fix test cluster (Dev C: 010+012+014)
- **Notes:** tests/canonical/test-catalog-dirs-parity.sh created: catalog<->skill-dirs parity (name==dir==row, aid- prefix, verb/artifact body-bind + engine delegation, repurpose exemption, no-orphan-dir/-row), count-agnostic; corroborated by build-shortcut-skills.py --check.
