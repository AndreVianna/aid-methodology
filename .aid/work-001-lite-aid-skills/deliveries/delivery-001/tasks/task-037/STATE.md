...
- **Notes:** aid-plan SKILL.md + first-run-loop.md + review-deliverables.md repointed to deliveries/delivery-NNN/BLUEPRINT.md; feature-spec scan unchanged; no old-nested refs (grep-clean).
