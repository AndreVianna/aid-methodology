...
- **Notes:** reader.py (9 refs) + reader.mjs (6 refs) repointed in lockstep to deliveries/.../{BLUEPRINT,DETAIL}.md; work-root SPEC.md identity fallback unchanged; test_reader.py 100 pass / 1 env-artifact (Windows short-path in TestLocator, unrelated to rename).
