...
- **Notes:** Templates renamed → delivery-blueprint-template.md + task-detail-template.md; old names gone; Gate Criteria preserved; internal path refs → DETAIL.md. Render green.
