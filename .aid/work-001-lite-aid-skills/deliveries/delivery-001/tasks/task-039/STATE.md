...
- **Notes:** aid-execute SKILL.md + state-execute.md + state-delivery-gate.md repointed to deliveries/.../DETAIL.md; DELIVERY-GATE MIS-WIRE FIXED (criteria now read from BLUEPRINT.md § GATE CRITERIA, not PLAN.md); lite-path wording dropped; no old-nested refs.
