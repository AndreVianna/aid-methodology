...
- **Notes:** aid-detail SKILL.md + first-run.md + task-decomposition.md + review.md + reviewer-brief.md repointed to deliveries/.../DETAIL.md + task-detail-template.md; no old-nested refs (grep-clean).
