...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** Implemented: 5 catalog rows + test-experiment.md scaffolding; 5 doorways generated; render VERIFY PASS; dogfood resynced; catalog-parity green (55/55 total).
