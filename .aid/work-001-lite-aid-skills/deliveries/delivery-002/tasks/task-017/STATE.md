...
- **Review:** Pending
- **Elapsed:** --
- **Notes:** Implemented: 25 catalog rows + change-refactor.md scaffolding (inherits create.md matrix); 25 doorways generated; render VERIFY PASS; dogfood resynced; catalog-parity green.
