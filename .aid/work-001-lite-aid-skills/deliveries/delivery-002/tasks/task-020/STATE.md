...
- **State:** Done
- **Review:** self-verified: bash tests/canonical/test-test-experiment-family-scaffold.sh -- 89/89 passed
- **Elapsed:** delivery-002 test cluster (Dev E: 016+018+020)
- **Notes:** tests/canonical/test-test-experiment-family-scaffold.sh created: test-experiment.md contract assertions (aid-test's two inferred modes, aid-test-security's SPEC activation + findings-route-to-aid-fix, aid-experiment's RESEARCH->[IMPLEMENT]->RESEARCH chain, Ownership boundary), catalog contract against the real catalog+dirs (exactly 5 G7 rows, no aliases, test/test-* -> TEST, experiment -> RESEARCH), and fixture-shape halt-proofs for aid-test-security (### Security Specs + TEST, findings route to aid-fix), aid-experiment (RESEARCH task-001, AC-4), and aid-test model-eval mode.
