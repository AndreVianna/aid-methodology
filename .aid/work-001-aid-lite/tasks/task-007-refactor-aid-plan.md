...
**Scope:**
- Extract each `## Mode: NAME` H2 block in `canonical/skills/aid-plan/SKILL.md` into a separate `references/state-{name}.md` file (lowercase, hyphenated).
