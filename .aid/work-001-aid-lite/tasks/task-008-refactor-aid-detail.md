...
**Scope:**
- Extract each `## Mode: NAME` H2 block in `canonical/skills/aid-detail/SKILL.md` into a separate `references/state-{name}.md` file (lowercase, hyphenated).
...
- Note: extracts the per-state TASK BREAKDOWN logic + Execution Graph generation — both substantial reference files.
