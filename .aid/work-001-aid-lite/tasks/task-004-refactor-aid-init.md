...
**Scope:**
- Extract each `## Mode: NAME` H2 block in `canonical/skills/aid-init/SKILL.md` into a separate `references/state-{name}.md` file (lowercase, hyphenated).
...
- Note: leaves a clear insertion point in the question block for delivery-005's new MaxConcurrent question (between Q6 Heartbeat Interval and the current Q7 Commit AID Workspace).
