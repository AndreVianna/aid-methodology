...
**Scope:**
- Extract each `## Mode: NAME` H2 block in `canonical/skills/aid-summarize/SKILL.md` into a separate `references/state-{name}.md` file (lowercase, hyphenated).
...
- Note: small-mid skill with 10 modes; pay attention to STALE-CHECK + DONE-IDEMPOTENT composite dispatch.
