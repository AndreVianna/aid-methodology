...
**Scope:**
- Extract each `## Mode: NAME` H2 block in `canonical/skills/aid-specify/SKILL.md` into a separate `references/state-{name}.md` file (lowercase, hyphenated).
...
- Note: large; many states (INITIALIZE / CONTINUE / SPIKE / BLOCKED / REVIEW / DONE) — pay attention to The Loop transitions.
