...
Generated by /aid-detail 2026-05-24. Each delivery's graph describes
intra-delivery + cross-delivery task dependencies. `aid-execute` consumes
these graphs to determine task ordering and parallelism.

### delivery-001: Skill Footprint Refactor — 12 tasks
...
| task-010 | — |
| task-011 | — |
| task-012 | task-001, task-002, task-003, task-004, task-005, task-006, task-007, task-008, task-009, task-010, task-011 |

| Can Be Done In Parallel |
|------------------------|
| task-001, task-002, task-003, task-004, task-005, task-006, task-007, task-008, task-009, task-010, task-011 |

**Critical path:** any of {task-001..task-011} → task-012 (2 nodes). Largest of the 11 parallel tasks (likely task-010 aid-discover, 596 lines) gates task-012.

### delivery-002: Lite Path with Type-Aware Routing — 6 tasks
...
|------|-----------|
| task-013 | — |
| task-014 | task-005, task-013 |
| task-015 | task-014 |
| task-016 | task-014 |
| task-017 | task-014, task-016 |
| task-018 | task-013, task-014, task-015, task-016, task-017 |

| Can Be Done In Parallel |
|------------------------|
| task-015, task-016 |

**Critical path:** task-013 → task-014 → task-016 → task-017 → task-018 (5 nodes). task-015 (user-override) runs parallel to task-016 (sub-paths) after task-014.

### delivery-003: Two-Tier Review Model — 5 tasks
...
| task-019 | — |
| task-020 | — |
| task-021 | task-009, task-019, task-020 |
| task-022 | task-019, task-020, task-021 |
| task-023 | task-021, task-022 |

| Can Be Done In Parallel |
|------------------------|
| task-019, task-020 |

**Critical path:** task-019 → task-021 → task-022 → task-023 (4 nodes). task-020 runs parallel to task-019.

### delivery-004: Recipes Catalog — 7 tasks
...
| task-026 | task-025 |
| task-027 | task-025 |
| task-028 | task-015, task-024, task-026, task-027 |
| task-029 | task-017, task-028 |
| task-030 | task-024, task-026, task-027, task-028, task-029 |
...
**Critical path:** task-025 → task-027 → task-028 → task-029 → task-030 (5 nodes). task-024 runs parallel to task-025; task-026 runs parallel to task-027.

### delivery-005: Parallel Pool Execution — 7 tasks
...
**Critical path:** task-031 → task-033 → (task-034 / task-035 / task-036 in parallel) → task-037 (4 nodes). task-032 (aid-init Q) runs parallel to task-033 (pool dispatch).
