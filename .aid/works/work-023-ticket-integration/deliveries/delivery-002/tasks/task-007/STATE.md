---
state: Done
review: 'self-verified: 6 read seams delegate to /aid-read-ticket (grep=1 each); ticket_ref LOCAL-LINK preserved; dual-anchor/write files zero-diff. Independent review at delivery-002 gate'
elapsed: "--"
notes: "--"
...
<!-- AUTHORED -- values live in the YAML frontmatter block at the top of this file
     ...
     `writeback-state.sh --task-id 007 --field State --value VALUE`.
...
<!-- AUTHORED -- written by `writeback-state.sh --task-id 007 --findings ...` during the
