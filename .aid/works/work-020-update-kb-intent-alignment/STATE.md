...
| 2026-07-22 | Reconciled + PR opened | -- | Merged origin/master PR #163 (release 2.2.3-beta.2, disjoint, clean) → branch current with master. Pushed branch; opened **PR #164** (work-020 → master) via AndreVianna gh acct (restored to AndreVianna-Ross after). NOT merged — maintainer merges after CI green |
