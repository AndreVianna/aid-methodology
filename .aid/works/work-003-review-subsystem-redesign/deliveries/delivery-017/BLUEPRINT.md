...
- The `aid-deep-review` INTAKE gate, one site covering every definition skill plus `aid-review` plus
  the shortcut engine.
...
- [ ] The INTAKE gate runs before any dispatch, and blocks it on exit 1
...
| task-002 | CONFIGURE | 2 | INTAKE gate and CI step |
