...
`deliveries/delivery-005/tasks/task-051/STATE.md`. The `## Task State` mutable cell
...
`task-051`/`delivery-005`/`work-001-skill-explorer` in the header blockquote below are INFERRED
