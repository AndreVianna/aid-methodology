...
`deliveries/delivery-005/tasks/task-053/STATE.md`. The `## Task State` mutable cell
...
findings, dispatch log). Its parent `deliveries/delivery-005/STATE.md ## Tasks State` and
...
`task-053`/`delivery-005`/`work-001-skill-explorer` in the header blockquote below are INFERRED
