...
`deliveries/delivery-005/tasks/task-049/STATE.md`. The `## Task State` mutable cell
...
`task-049`/`delivery-005`/`work-001-skill-explorer` in the header blockquote below are INFERRED
