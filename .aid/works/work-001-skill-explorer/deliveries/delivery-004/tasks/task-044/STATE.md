...
`deliveries/delivery-004/tasks/task-044/STATE.md`. The `## Task State` mutable cell
...
findings, dispatch log). Its parent `deliveries/delivery-004/STATE.md ## Tasks State` and
...
`task-044`/`delivery-004`/`work-001-skill-explorer` in the header blockquote below are INFERRED
