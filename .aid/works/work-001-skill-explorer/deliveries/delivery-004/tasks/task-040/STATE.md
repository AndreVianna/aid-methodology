...
`deliveries/delivery-004/tasks/task-040/STATE.md`. The `## Task State` mutable cell
...
`task-040`/`delivery-004`/`work-001-skill-explorer` in the header blockquote below are INFERRED
