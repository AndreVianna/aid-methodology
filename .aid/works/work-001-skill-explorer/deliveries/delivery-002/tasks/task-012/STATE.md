...
`deliveries/delivery-002/tasks/task-012/STATE.md`. The `## Task State` mutable cell
...
`task-012`/`delivery-002`/`work-001-skill-explorer` in the header blockquote below are INFERRED
