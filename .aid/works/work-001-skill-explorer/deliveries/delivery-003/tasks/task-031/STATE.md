...
`deliveries/delivery-003/tasks/task-031/STATE.md`. The `## Task State` mutable cell
...
`task-031`/`delivery-003`/`work-001-skill-explorer` in the header blockquote below are INFERRED
