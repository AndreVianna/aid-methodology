...
`deliveries/delivery-003/tasks/task-030/STATE.md`. The `## Task State` mutable cell
...
`task-030`/`delivery-003`/`work-001-skill-explorer` in the header blockquote below are INFERRED
