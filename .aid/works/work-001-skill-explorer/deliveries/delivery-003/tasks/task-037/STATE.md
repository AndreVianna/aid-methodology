...
`deliveries/delivery-003/tasks/task-037/STATE.md`. The `## Task State` mutable cell
...
`task-037`/`delivery-003`/`work-001-skill-explorer` in the header blockquote below are INFERRED
