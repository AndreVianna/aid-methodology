...
`deliveries/delivery-003/tasks/task-034/STATE.md`. The `## Task State` mutable cell
...
`task-034`/`delivery-003`/`work-001-skill-explorer` in the header blockquote below are INFERRED
