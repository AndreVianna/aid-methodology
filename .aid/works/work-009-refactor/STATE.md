...
| task-011 | In Progress | -- | -- | -- | Cross-format, cross-runtime characterization suite |
...
| task-015 | Pending | -- | -- | -- | Update the in-scope canonical shell suites to the YAML state format |
...
| task-018 | Pending | -- | -- | -- | Update the Knowledge Base to the YAML state format |
