ARTIFACTS UNDER REVIEW:
  - .aid/works/work-013-review-stack-completion/PLAN.md
      (the delivery-001 stanza, the "Why two, and not one or three" section, the
       Cross-Cutting Risks table and the Open-before-Detail table)
  - .aid/works/work-013-review-stack-completion/deliveries/delivery-001/BLUEPRINT.md
  - .aid/works/work-013-review-stack-completion/deliveries/delivery-001/STATE.yml

  Readable to verify a claim, NOT graded here: the two feature SPECs delivery-001 assigns
  (feature-001-single-review-path-alignment, feature-002-coverage-gate-completion) and
  REQUIREMENTS.md.
