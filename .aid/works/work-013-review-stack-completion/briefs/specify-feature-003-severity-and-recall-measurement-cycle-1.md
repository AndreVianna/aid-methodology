...
CONTEXT:
  SPEC.md for feature-003-severity-and-recall-measurement in work-013-review-stack-completion.
  The technical specification was just written by aid-architect. This is the review pass
  before the feature is marked Ready.

  T3 Measure & judge — the severity why-line, structural clean context, seeded recall, class sweep, observe-only boundary (FR-C1..FR-C6). Q8 and Q9 are Pending and land here. NFR-1 is the sharpest constraint: the why-line must live inside the existing 7 columns.
...
DELIVERABLES:
  - Ledger at `.aid/.temp/review-pending/specify-feature-003.md` per
  ...
  - After writing it, run and report:
    `bash .cursor/aid/scripts/grade.sh --explain .aid/.temp/review-pending/specify-feature-003.md`
