ARTIFACTS UNDER REVIEW:
  One task, opening delivery-002. Cycle 1, so ONE unlabelled list.

    - .aid/works/work-013-review-stack-completion/deliveries/delivery-002/RECORD.md

  Readable to verify a claim, NOT graded: the delivery-002 BLUEPRINT, task-026's DETAIL,
  delivery-001's RECORD (for the lessons this one claims to carry forward), and any file a
