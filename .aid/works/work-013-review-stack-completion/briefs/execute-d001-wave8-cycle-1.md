ARTIFACTS UNDER REVIEW:
  ...
  Readable to verify a claim, NOT graded: the registry and oracle it reasons about
  (.aid/knowledge/authoring-conventions.md, scripts/checks/g07-selector-partition.sh),
  kb-citation-lint.sh, and task-021's DETAIL.md.
