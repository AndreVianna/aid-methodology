# task-003: Catalog screening — classes KB and EXE
...
**Scope:**
- Read the KB and EXE rule rows (29 of 85) from the canceled branch via `git show 8b9e62021:…`; never check that branch out.
