# task-004: Catalog screening — classes PRE, NAR and INT
...
**Scope:**
- Read the PRE, NAR and INT rule rows (27 of 85) from the canceled branch via `git show 8b9e62021:…`; never check that branch out.
...
**Acceptance Criteria:**
- [ ] All 27 rows carry a recorded outcome — `admit`, `covered by <id>`, `rubric-owned`, or `needs a new type — out of scope` — each with its evidence.
