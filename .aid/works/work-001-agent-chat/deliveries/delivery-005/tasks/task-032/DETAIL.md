...
- [ ] **In a two-member channel a whisper behaves as an ordinary message** -- accepted, and visible to both members -- per FR-3.7, which is the case the three-or-more criteria above do not reach.
