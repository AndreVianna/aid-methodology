...
<!-- AUTHORED -- values live in the YAML frontmatter block at the top of this file
     ...
     `writeback-state.sh --task-id 031 --field State --value VALUE` (surgical frontmatter rewrite).
...
<!-- AUTHORED -- written by `writeback-state.sh --task-id 031 --findings ...` during the
