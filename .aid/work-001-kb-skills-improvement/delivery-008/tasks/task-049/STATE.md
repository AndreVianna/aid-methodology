...
- **Review:** Pending
- **Elapsed:** ~20m
- **Notes:** All ACs verified. Generator no-op (profiles already regenerated by prior commits). Dry-run release verified: 5 tarballs contain aid-query-kb+aid-update-kb, zero aid-ask. DBI: 553/553 pass. ASCII: 28/28 pass. test-release.sh: 70/70 pass. npm/pypi confirmed non-surface.
