# task-040: kb-freshness-check.sh -- deterministic per-doc staleness script
...
`aid-update-kb` (f008/delivery-008) or `aid-housekeep` (f010/delivery-009) that scope work off these
verdicts. The dashboard reader surfacing is task-042/task-043, not here.
