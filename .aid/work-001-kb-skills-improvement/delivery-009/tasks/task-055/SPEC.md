# task-055: f010 behavioral guards -- suspect scoping + before-commit closure re-verify
...
- **Cross-delivery citation:** the guards assert the task-054 rewrite of
  `canonical/skills/aid-housekeep/references/state-kb-delta.md` and reference
  `canonical/skills/aid-update-kb/references/state-done.md` (task-048/f008, the update-kb closure
...
- [ ] The guards are wired into CI (a `tests/canonical/` assertion or an existing skill-shape test)
  and pass against the task-054 rewrite.
