# task-031: test-calibration-fixtures.sh + f005 SPIKE-C1 floor pinning

**Type:** TEST

**Source:** work-001-kb-skills-improvement -> delivery-005

**Depends on:** task-028, task-008 (delivery-001)
...
- The suite runs f004's SHIPPED MERGED `closure-check.sh` (delivery-001 task-008) -- outputs (b)
  ...
  coverage script (`kb-salient-coverage.sh` was dropped) -- over the task-028 `calibration/` fixture
