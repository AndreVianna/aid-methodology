...
**Acceptance Criteria:**
- [ ] The 5 profile execute copies + the `.claude/scripts/execute/` copy carry the task-003 retarget + state naming, byte-consistent with `canonical/scripts/execute/writeback-state.sh`.
