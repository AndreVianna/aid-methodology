...
| **CI** | **GitHub Actions (enforced)** | `.github/workflows/test.yml` runs render-drift + 7 suites + generator self-tests + hygiene on PR/push; required status check on `master` | See `test-landscape.md` |
