...
changelog:
  - 2026-06-04: Generated
---

<!-- AUTO-GENERATED 2026-06-04T01:37:20Z by .claude/scripts/kb/build-kb-index.sh -->
<!-- DO NOT EDIT — regenerate with: bash .claude/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md -->

# Knowledge Base Index

> Auto-generated by `build-kb-index.sh` from each doc's `intent:` frontmatter field.
> Do not edit by hand. Generated at: 2026-06-04T01:37:20Z.
...
*To regenerate this index, run `bash .claude/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md`.*
