...
| 5 | 2026-07-25 | work-001-skill-explorer `/aid-describe` hydration — 1 doc touched, additive only. `module-map.md` rev 1.5 gains a **Skill Structural Shapes** section: the four skill *body* shapes (fat pipeline / hand-authored collapse / generated doorway / kind-sibling doorway) and how they cut across the 17+64+30 *ownership* taxonomy; `repurpose: true` clarified as a generator-ownership flag, not a structural signal (`aid-review` 221 lines and `aid-test-security` 24 lines both carry it); the two doorway shapes carry no control flow of their own (~94 of 111 skills resolve to the shared shortcut engine); no single reliable state-machine parse marker exists across the corpus. No discovery content overwritten; no doc-set or completeness change. |
...
| 1.4 | 2026-07-25 | work-001-skill-explorer describe-phase hydration (1 doc, additive): `module-map.md` Skill Structural Shapes. |
