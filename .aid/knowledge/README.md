...
|---|----------|--------|---------------|-------|
| 1 | [project-structure.md](project-structure.md) | Populated | 2026-06-03 | aid-researcher (scout doc-set) + cycle-10 §9a T3-strip; aid-housekeep (11 skills, scripts/housekeep/, 18→24 suites); stripped all hardcoded file/line counts → pointer to project-index.md |
...
| 3 | [architecture.md](architecture.md) | Populated | 2026-06-03 | aid-researcher (architecture doc-set); cycle-10 aid-housekeep (11-skill inventory table, on-demand data-flow + entry-point); §9a fixes (three→five trees, setup line counts stripped, branch de-pinned) |
...
| 5 | [module-map.md](module-map.md) | Populated | 2026-06-03 | aid-researcher (analyst doc-set); cycle-10 aid-housekeep (11→12 total skills, aid-housekeep module row, new §4f scripts/housekeep/) |
| 6 | [coding-standards.md](coding-standards.md) | Populated | 2026-06-03 | aid-researcher (analyst doc-set); cycle-9 §7a/§7d byte-identity 3→5 profiles / 7-tree; cycle-10 fix (10→11 user-facing skills) |
| 7 | [schemas.md](schemas.md) | Populated | 2026-06-01 | aid-researcher (analyst doc-set); cycle-9 post-merge update (agent.format enum, RuleEntry.output_filename, ExtrasConfig.rules_frontmatter, manifest profile enum) |
| 8 | [pipeline-contracts.md](pipeline-contracts.md) | Populated | 2026-06-03 | aid-researcher (integrator doc-set); cycle-10 aid-housekeep (new /aid-housekeep API section, 3 housekeep script CLIs, Housekeep Status block, Q&A handshake) |
| 9 | [integration-map.md](integration-map.md) | Populated | 2026-06-03 | aid-researcher (integrator doc-set); cycle-10 aid-housekeep (11 dirs, skill enumeration, State-File R/W row, git-using-skill row) |
| 10 | [domain-glossary.md](domain-glossary.md) | Populated | 2026-06-03 | aid-researcher (integrator doc-set); cycle-10 aid-housekeep terms (Housekeep/KB-drift reconciliation, Housekeep Status, aid/housekeep-* branch, --cleanup-only); removed stale kb-overhaul term |
| 11 | [test-landscape.md](test-landscape.md) | Populated | 2026-06-03 | aid-researcher (quality doc-set); cycle-10 aid-housekeep (18→24 suites; 5 test-housekeep-* sections + test-complexity-score; 1:1 disk mapping verified) |
| 12 | [tech-debt.md](tech-debt.md) | Populated | 2026-06-03 | aid-researcher (quality doc-set); cycle-10 fix — stale "18 suites" → 24, de-pinned count per §9a, Last Updated refreshed. (cycle-9: 4 LOW work-001 residuals) |
...
| 2 | 2026-05-27 | cycle-1 | REVIEW complete | aid-reviewer 11m57s. Grade E+ (35 findings: 0C / 16H / 11M / 11L / 0MIN). 5 new Q&A (Q11-Q15). |
...
| 6 | 2026-05-27 | cycle-2 | REVIEW complete | aid-reviewer ~13m. Grade D+ (computed by grade.sh; 16C / 24H / 20M / 5L / 8MIN findings). 5 new Q&A (Q18-Q22). CC1: CLAUDE.md collapsed; CC2: verify-claims.sh cascade not swept. |
...
| 8 | 2026-05-27 | cycle-3 | REVIEW complete | aid-reviewer ~12m. Grade E+ (computed by grade.sh; 0C / 5H / 14M / 16L / 7MIN findings). No new Q&A — all findings mechanically resolvable. Both cycle-2 cascades CLEAN; 5H residue + drift items. |
...
| 12 | 2026-05-27 | cycle-5 | REVIEW complete | aid-reviewer ~27m (cycle-5 verification discipline: re-run each suite). 19 findings (0C / 3H / 0M / 12L / 4MIN). 3 HIGHs all the same test-count root cause from cycle-3/cycle-4. **Reviewer was right both times.** 0 MEDIUM target hit. |
...
| 17 | 2026-06-01 | cycle-9 | REVIEW complete (post-merge) | Re-discovery triggered by work-001-add-providers merge (PRs #42/#43/#44). aid-reviewer graded the pre-merge KB against current code: **D-** (35 findings: 0C / 15H / 12M / 8L / 0MIN) — the 3→5 profile root error cascading across ~13 docs + missing coverage of the 2 new providers, 2 new formats, schema additions, collision handler, 2 emitter test suites. Q23-Q25 added (vendor-confirmation residuals → recorded as LOW tech-debt). |
