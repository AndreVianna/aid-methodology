...
**SKILL.md unification** (cycle-11 spot-check #1, #2): `aid-discover/SKILL.md` is **258 lines in all three profile trees AND in canonical** (verified `wc -l`). The pre-2026-05-22 drift the KB used to claim (258 / 1,078 / 1,090) no longer exists — the canonical source is the single truth and the generator copies it byte-identically into all profiles.
...
7. **Skill body parity** (replaces "skill body length drift" anomaly): `aid-discover/SKILL.md` is 258 lines in **all four locations** — `canonical/skills/aid-discover/`, `profiles/claude-code/.claude/skills/aid-discover/`, `profiles/codex/.agents/skills/aid-discover/`, `profiles/cursor/.cursor/skills/aid-discover/` — verified `wc -l` (cycle-11 spot-checks #1, #2). The pre-2026-05-22 KB claim of 258 / 1,078 / 1,090 divergence is obsolete.
