...
**SKILL.md unification**: `aid-discover/SKILL.md` is **307 lines in all three profile trees AND in canonical** (verified `wc -l`). The pre-canonical-generator drift the KB used to claim (Claude Code 453 / Codex 1,078 / Cursor 1,090) no longer exists — the canonical source is the single truth and the generator copies it byte-identically into all profile trees.
...
7. **Skill body parity** (replaces "skill body length drift" anomaly): `aid-discover/SKILL.md` is 307 lines in **all four locations of the canonical-generator's emission scope** — `canonical/skills/aid-discover/`, `profiles/claude-code/.claude/skills/aid-discover/`, `profiles/codex/.agents/skills/aid-discover/`, `profiles/cursor/.cursor/skills/aid-discover/` — verified `wc -l`. The pre-canonical-generator KB claim of Claude Code 453 / Codex 1,078 / Cursor 1,090 divergence is obsolete.
