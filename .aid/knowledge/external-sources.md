...
- `profiles/cursor/.cursor/skills/aid-discover/SKILL.md` — 307 lines (post-work-001 thin-router refactor + cycle-19 orchestrator-protocol additions; byte-identical via canonical-generator; pre-canonical-generator the Cursor tree was 1,090 lines).
