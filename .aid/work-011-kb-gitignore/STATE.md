...
> **State:** Shipped — released in v2.0.4 (PR #121 merged; tag v2.0.4; GitHub Release + npm + PyPI all live at 2.0.4)
> **Phase:** Execute
...
| 2026-07-05 | v2.0.4 SHIPPED | -- | PR #121 merged to master (4d79f157). Dry-run (release.yml, ref=master) green: gate + github-release + npm + pypi all success. Annotated tag v2.0.4 pushed → release.yml run 28732084257 SUCCESS: GitHub Release "AID v2.0.4" (not draft, 9 assets: 5 profile tarballs + aid-cli + AidInstallCore.psm1 + aid-install-core.sh + SHA256SUMS), rewritten notes applied (covers work-010 tool-tree scope + work-011 .gitignore/smart-exclusion). Registries live: npm aid-installer=2.0.4, PyPI aid-installer=2.0.4. v2.0.4 ships work-010 (tool-tree scope) + work-011 (.gitignore + smart exclusion) together. |
