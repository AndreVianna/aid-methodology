...
description: >
  ...
  .cursor/skills/aid-change-document/SKILL.md.
...
(`.cursor/skills/aid-change-document/SKILL.md`), per the alias-is-a-full-directory
...
constraint -- is defined exclusively by `.cursor/skills/aid-change-document/SKILL.md`.
