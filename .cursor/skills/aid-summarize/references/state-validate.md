...
Run `.cursor/aid/scripts/summarize/grade-summary.sh .aid/knowledge/kb.html`. It orchestrates the AUTO_POOL (machine-verifiable) checks only:
...
`{{LEDGER}}` (per `.cursor/aid/templates/reviewer-ledger-schema.md`):
