...
`.cursor/aid/templates/reviewer-dispatch.md` § Dispatch by path: the `Agent` prompt carries the
...
```bash
bash .cursor/aid/scripts/grade.sh --explain .aid/.temp/review-pending/{{SCOPE}}.md
```
