...
Read the invocation manifest (`.cursor/aid/templates/reviewer-brief-template.md` § invocation
...
- `.cursor/agents/aid-screener/AGENT.md` — the agent dispatched here
- `.cursor/aid/templates/reviewer-brief-template.md` — the invocation manifest
