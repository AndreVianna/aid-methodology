...
description: >
  ...
  of its own -- its full behavior is defined by .cursor/skills/aid-review/SKILL.md.
...
`/aid-audit` is the alias of **`/aid-review`** (`.cursor/skills/aid-review/SKILL.md`),
per the same alias-is-a-full-directory convention the shortcut catalog uses
(`.cursor/aid/templates/shortcut-catalog.yml` Topology note: an alias is a full,
...
and every constraint -- is defined exclusively by `.cursor/skills/aid-review/SKILL.md`.
