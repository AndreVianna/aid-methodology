...
(`.cursor/skills/aid-discover/references/state-review.md`) with the f005
...
Follow `.cursor/skills/aid-discover/references/state-review.md` verbatim,
substituting:
...
```bash
bash .cursor/aid/scripts/review/check-gaps.sh --ledger .aid/.temp/review-pending/update-kb.md   # exit 1 = an open criteria gap; do NOT grade
...
```bash
bash .cursor/aid/scripts/config/read-setting.sh \
