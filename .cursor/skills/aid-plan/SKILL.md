...
`.cursor/aid/templates/requirements/requirements-template.md § Verifiable Acceptance Criteria`):
...
Seeded from `.cursor/aid/templates/delivery-state-template.yml` with:
