...
function main() {
	...
	const scaleCeilingPath = path.join(repoRoot, '.cursor/aid/templates/graph/scale-ceiling.yml');
	...
	// vendors .cursor/aid/templates/knowledge-graph/vendor/, present after, no
