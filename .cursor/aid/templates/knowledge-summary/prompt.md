...
`.cursor/aid/templates/knowledge-summary/section-templates/bespoke-components.md`:
...
bash .cursor/aid/scripts/summarize/assemble.sh --output .aid/knowledge/kb.html
```
