...
`node .cursor/aid/scripts/summarize/validate-visuals.mjs .aid/knowledge/kb.html`
...
```
$ bash .cursor/aid/scripts/summarize/emit-summary-findings.sh .aid/knowledge/kb.html --dry-run
