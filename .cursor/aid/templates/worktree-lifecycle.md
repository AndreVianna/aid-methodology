...
`.cursor/aid/scripts/works/worktree-lifecycle.sh`. The script is pure git mechanics -- it
...
```bash
bash .cursor/aid/scripts/works/worktree-lifecycle.sh create <work-id> <name> [--base <ref>]
bash .cursor/aid/scripts/works/worktree-lifecycle.sh locate <work-id> [--name <slug>]
```
