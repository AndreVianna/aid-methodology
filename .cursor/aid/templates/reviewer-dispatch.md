...
This document lives in `.cursor/aid/templates/` and is a **skill-bundle artifact**, not a KB document.
...
- `.cursor/agents/aid-reviewer/` — the deep reviewer; `.cursor/agents/aid-screener/` — the screener
