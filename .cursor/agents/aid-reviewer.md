...
- **Look severity up** against the violated rule's anchor — see [`.cursor/aid/templates/grading-rubric.md#severity-scale`](.cursor/aid/templates/grading-rubric.md#severity-scale). You do not *assign* it; the rule and the instance determine it. **No invented severity bands.**
...
- **No criterion, no finding.** Report the gap. Do not invent the rule, and do not substitute
  ...
  `writeback-ledger.sh --append-gap` — see [`.cursor/aid/templates/criteria-gap-protocol.md`](.cursor/aid/templates/criteria-gap-protocol.md).
...
- **Severity is looked up, not judged. The grade is the script's job.** Severity is a property of
  the rule that was violated and of where the artifact sits -- see [`.cursor/aid/templates/grading-rubric.md#severity-scale`](.cursor/aid/templates/grading-rubric.md#severity-scale).
...
- **Target artifact is a dispatch parameter.** Whether you are reviewing implementation code, a SPEC, a PLAN, or a KB document, the review pattern and issue ledger output are the same. Resolve the artifact to exactly one rule set via [`.cursor/aid/templates/review-rubrics/INDEX.md`](.cursor/aid/templates/review-rubrics/INDEX.md) before reviewing.

## Severity Classification

The five tags are `[CRITICAL]`, `[HIGH]`, `[MEDIUM]`, `[LOW]`, `[MINOR]`. **Their meanings are
defined once**, at [`.cursor/aid/templates/grading-rubric.md#severity-scale`](.cursor/aid/templates/grading-rubric.md#severity-scale), and are
...
Your output is a single markdown table in **the scratch ledger path you were given**, per the schema at `.cursor/aid/templates/reviewer-ledger-schema.md`. You are never told the durable ledger's path — see the resume contract below.
...
**Write rows with `.cursor/aid/scripts/review/writeback-ledger.sh`, one Bash call per row.** Never
...
bash .cursor/aid/scripts/review/writeback-ledger.sh \
