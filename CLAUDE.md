...
5. **Spec-as-hypothesis with formal revision** — every artifact template has `## Revision History`; feedback loops produce GAP.md and IMPEDIMENT.md; Reviewer tags issues by source `[CODE]/[TASK]/[SPEC]/[KB]/[ARCHITECTURE]`.
