...
description: 'Create an API endpoint / middleware (contract, handler, validation).'
...
~~~~plaintext title="canonical/skills/aid-create-api/SKILL.md#L17" wrap
...
[Source: `canonical/skills/aid-create-api/SKILL.md#L17`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-create-api/SKILL.md#L17)
