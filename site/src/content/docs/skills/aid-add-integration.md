...
<a id="fragment-n1"></a>**1 · `aid-add-integration`** — Bind VERB=create, ARTIFACT=integration · _entry_

~~~~plaintext title="canonical/skills/aid-add-integration/SKILL.md#L20" wrap
...
[Source: `canonical/skills/aid-add-integration/SKILL.md#L20`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-integration/SKILL.md#L20)
