...
~~~~plaintext title="canonical/skills/aid-document/SKILL.md#L19" wrap
row (`alias_of: null`, its own `{verb: document, artifact: ""}`), `repurpose: true`
~~~~

[Source: `canonical/skills/aid-document/SKILL.md#L19`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-document/SKILL.md#L19)
