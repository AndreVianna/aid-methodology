...
description: 'Direct-entry Lite-path shortcut (Update an existing CLI command.) -- skips the aid-describe interview/triage.'
...
~~~~plaintext title="canonical/skills/aid-update-cli/SKILL.md#L18" wrap
...
[Source: `canonical/skills/aid-update-cli/SKILL.md#L18`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-update-cli/SKILL.md#L18)
