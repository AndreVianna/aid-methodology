...
~~~~plaintext title="canonical/skills/aid-add-document/SKILL.md#L1" wrap
---
~~~~

[Source: `canonical/skills/aid-add-document/SKILL.md#L1`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-document/SKILL.md#L1)

<a id="fragment-n2"></a>**2 · `RUN`** — Run Alias of /aid-create-document -- create a document NOW… · _step_

~~~~plaintext title="canonical/skills/aid-add-document/SKILL.md#L3" wrap
description: >
~~~~

[Source: `canonical/skills/aid-add-document/SKILL.md#L3`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-document/SKILL.md#L3)

<a id="fragment-n3"></a>**3 · `EXIT`** · _exit_ · HALT

~~~~plaintext title="canonical/skills/aid-add-document/SKILL.md#L14" wrap
---
~~~~

[Source: `canonical/skills/aid-add-document/SKILL.md#L14`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-document/SKILL.md#L14)
