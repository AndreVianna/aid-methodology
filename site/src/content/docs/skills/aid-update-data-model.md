...
<a id="fragment-n1"></a>**1 · `aid-update-data-model`** — Bind VERB=change, ARTIFACT=data-model · _entry_

~~~~plaintext title="canonical/skills/aid-update-data-model/SKILL.md#L20" wrap
...
[Source: `canonical/skills/aid-update-data-model/SKILL.md#L20`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-update-data-model/SKILL.md#L20)
