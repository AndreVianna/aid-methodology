---
title: 'aid-add-test'
description: 'Direct-entry Lite-path shortcut (Alias of aid-create-test.) -- skips the aid-describe interview/triage.'
generatedFrom: 'canonical/skills/aid-add-test/SKILL.md'
---

<!-- generated — do not edit; source: canonical/skills/aid-add-test/SKILL.md -->

## Frontmatter

- **`name`** — aid-add-test
- **`description`** — Direct-entry Lite-path shortcut (Alias of aid-create-test.) -- skips the aid-describe interview/triage. Binds VERB=`create` ARTIFACT=`test` and runs the shared shortcut engine, producing a fully-graded flattened Lite work that halts for approval. State machine: delegated to canonical/aid/templates/shortcut-engine.md (INTAKE -> CAPTURE -> SPEC -> PLAN -> DETAIL -> GATE -> APPROVAL-HALT).
- **`allowed-tools`** — Read, Glob, Grep, Bash, Write, Edit, Agent
- **`argument-hint`** — [description]  -- what to create; runs straight to a graded flattened Lite work

[Definition: `canonical/skills/aid-add-test/SKILL.md`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-test/SKILL.md)
...
flowchart TB
  ...
  n1(["aid-add-test<br/>Bind VERB=create, ARTIFACT=test"])
  n2{"INTAKE"}
  n3(["CONTINUATION"])
...
<a id="fragment-n1"></a>**1 · `aid-add-test`** — Bind VERB=create, ARTIFACT=test · _entry_

~~~~plaintext title="canonical/skills/aid-add-test/SKILL.md#L20" wrap
...
[Source: `canonical/skills/aid-add-test/SKILL.md#L20`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-add-test/SKILL.md#L20)
