...
description: 'Build a durable dashboard / BI view (source -> visualization -> publish/refresh).'
...
- **`description`** — Build a durable dashboard / BI view (source -> visualization -> publish/refresh). Use this skill when you already know what to create and want it scoped, specified, and broken into reviewable tasks in a single pass, with no requirements interview. You approve the resulting plan before anything is built: this skill plans and stops, so run /aid-execute to carry the plan out.
...
~~~~plaintext title="canonical/skills/aid-create-dashboard/SKILL.md#L17" wrap
...
[Source: `canonical/skills/aid-create-dashboard/SKILL.md#L17`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-create-dashboard/SKILL.md#L17)
