...
flowchart TB
  ...
  n1(["aid-change-job<br/>Bind VERB=change, ARTIFACT=job"])
  n2{"INTAKE"}
  n3(["CONTINUATION"])
...
<a id="fragment-n1"></a>**1 · `aid-change-job`** — Bind VERB=change, ARTIFACT=job · _entry_

~~~~plaintext title="canonical/skills/aid-change-job/SKILL.md#L18" wrap
...
[Source: `canonical/skills/aid-change-job/SKILL.md#L18`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-change-job/SKILL.md#L18)
