...
description: 'Write a standard in one pass -- a mandatory rule, stating the rule, its scope, how compliance is enforced, and the exceptions.'
...
~~~~plaintext title="canonical/skills/aid-document-standard/SKILL.md#L20" wrap
row (`alias_of: null`, its own `{verb: document, artifact: standard}`), `repurpose: true`
~~~~

[Source: `canonical/skills/aid-document-standard/SKILL.md#L20`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-document-standard/SKILL.md#L20)
