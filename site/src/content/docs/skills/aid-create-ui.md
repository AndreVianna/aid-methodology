---
title: 'aid-create-ui'
description: 'Direct-entry Lite-path shortcut (Create a UI component or page.) -- skips the aid-describe interview/triage.'
generatedFrom: 'canonical/skills/aid-create-ui/SKILL.md'
---
...
flowchart TB
  ...
  n1(["aid-create-ui<br/>Bind VERB=create, ARTIFACT=ui"])
  n2{"INTAKE"}
  n3(["CONTINUATION"])
...
<a id="fragment-n1"></a>**1 · `aid-create-ui`** — Bind VERB=create, ARTIFACT=ui · _entry_

~~~~plaintext title="canonical/skills/aid-create-ui/SKILL.md#L18" wrap
...
[Source: `canonical/skills/aid-create-ui/SKILL.md#L18`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-create-ui/SKILL.md#L18)
