---
title: 'aid-create-ui'
description: 'Create a UI component or page.'
...
- **`name`** — aid-create-ui
- **`description`** — Create a UI component or page. Use this skill when you already know what to create and want it scoped, specified, and broken into reviewable tasks in a single pass, with no requirements interview. You approve the resulting plan before anything is built: this skill plans and stops, so run `/aid-execute` to carry the plan out.
...
~~~~plaintext title="canonical/skills/aid-create-ui/SKILL.md#L16" wrap
...
[Source: `canonical/skills/aid-create-ui/SKILL.md#L16`](https://github.com/AndreVianna/aid-methodology/blob/master/canonical/skills/aid-create-ui/SKILL.md#L16)
