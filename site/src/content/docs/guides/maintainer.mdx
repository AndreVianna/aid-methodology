...
| **VALIDATE** | Confirm canonical completeness — 10 skills, 9 agents, non-empty templates. |
...
The `/aid-generate` skill (invoked inside your AI tool) exposes two flags for targeted
