...
<Tabs syncKey="tool">
  ...
  <TabItem label="Codex">
    ...
    **What gets installed:**
    ...
    - `.codex/skills/` — skill markdown files
  ...
  <TabItem label="Cursor">
    ...
    **What gets installed:**
    - `.cursor/skills/` — skill markdown files
    - `.cursor/agents/` — agent markdown files
    - `AGENTS.md` — project-context file at the project root
  </TabItem>
  <TabItem label="Copilot CLI">
    ...
    **What gets installed:**
    ...
    - `.github/skills/` — skill markdown files
    - `AGENTS.md` — project-context file at the project root
  </TabItem>
  <TabItem label="Antigravity">
    ...
    **What gets installed:**
    - `.agent/agents/` — agent markdown files
    - `.agent/skills/` — skill markdown files
    - `AGENTS.md` — project-context file at the project root
  </TabItem>
</Tabs>
