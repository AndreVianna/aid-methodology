...
75 skills deliver AID: the 17 curated pipeline/on-demand/router skills above (including the `/aid-triage`
suggest-only router), 24 hand-authored specialist skills (including `/aid-ask` for Q&A), and 34 verb-first
shortcut skills (`/aid-fix`, `/aid-create-api`, …).
