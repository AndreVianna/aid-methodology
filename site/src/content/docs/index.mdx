...
*Three entry points (plus `/aid-ask` for a plain question) · 75 skills — 17 curated pipeline/on-demand/router skills
...
75 skills deliver AID: 17 curated skills — the pipeline phases above, the off-pipeline on-demand
