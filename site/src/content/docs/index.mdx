...
*Three entry points (plus `/aid-ask` for a plain question) · 111 skills — 19 classic pipeline/on-demand skills, the `/aid-triage`
router, `/aid-ask` (a Q&A alias of `/aid-query-kb`), and 64 verb-first shortcut skills. Name your change with a **shortcut** and the
...
111 skills deliver AID: the 19 classic pipeline/on-demand skills above, the `/aid-triage`
suggest-only router, `/aid-ask` (a Q&A alias of `/aid-query-kb`), and 64 verb-first shortcut skills (`/aid-fix`, `/aid-create-api`, …).
