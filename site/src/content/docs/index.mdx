...
*Three entry points (plus `/aid-ask` for a plain question) · 113 skills — 19 curated pipeline, on-demand and
...
113 skills deliver AID: 19 curated skills — the pipeline phases above, the off-pipeline on-demand
