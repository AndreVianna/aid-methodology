...
*Three entry points (plus `/aid-ask` for a plain question) · 78 skills — 20 curated pipeline/on-demand/router skills
...
78 skills deliver AID: 20 curated skills — the pipeline phases above, the off-pipeline on-demand
