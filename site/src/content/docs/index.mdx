...
*Twelve user-facing skills · five groups · two paths (TRIAGE-routed). The six numbered
...
2. **Describe → Define** — gather requirements conversationally; TRIAGE routes small work to the lite path automatically.
...
Twelve user-facing skills across five groups deliver these phases. When the work is small and
