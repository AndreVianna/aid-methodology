...
111 skills deliver AID: 17 curated skills — the pipeline phases above, the on-demand skills, and the
`/aid-triage` suggest-only router — plus the 94-row shortcut catalog's skills: 64 verb-first shortcut
