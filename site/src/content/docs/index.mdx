...
*Three entry points (plus `/aid-ask` for a plain question) · 112 skills — 18 curated pipeline/on-demand/router skills
(including `/aid-triage`), 60 hand-authored specialist skills (including `/aid-ask` for Q&A), and 34 verb-first
...
112 skills deliver AID: 18 curated skills — the pipeline phases above, the off-pipeline on-demand
...
94-row shortcut catalog's skills: 34 verb-first shortcut
skills (`/aid-fix`, `/aid-create-api`, …) and 60 hand-authored `repurpose` skills.
