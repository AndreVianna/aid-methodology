...
//   reference/agents.md    — agents table, count DERIVED from agents.length (10 on disk).
//                            Stating a number here is what went stale: this line read 9 while
//                            canonical/agents/ held 10.
