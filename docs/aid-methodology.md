...
*113 skill directories in total — 17 curated pipeline / on-demand / router skills plus the 94-row shortcut catalog's skills (58 canonical names + 36 aliases; 64 engine-generated verb-first shortcut doorways + 30 hand-authored `repurpose` skills). Unchanged: 10 agents, 14 KB doc types.*
...
canonical/  (single source of truth — never edit profiles/ directly)
  ├── skills/        (113 skill directories — 17 curated + 94 catalog skills)
  ├── agents/        (10 agents)
  └── aid/
