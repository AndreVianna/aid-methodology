...
| A **skill** rename / add / remove (changes the **75** count: 17 curated + 34 shortcuts + 24 repurpose skills) | kb.html **Four-plane module map** ("75 skills"); site **methodology skill diagrams**; README **R1**; the `gen-reference` roster test (asserts 75 on-disk dirs = the 17 curated skill names ∪ all 58 catalog rows — keep this assertion in sync if the count changes again) |
