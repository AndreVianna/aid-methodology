...
- `.claude/skills/` — 112 `aid-`-prefixed skill markdown files (18 curated pipeline / on-demand / router skills + the 94-row shortcut catalog's skills: 34 Lite-Path shortcut doorways + 60 hand-authored repurpose skills)
