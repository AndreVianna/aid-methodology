...
wildcards beyond the artifact set (e.g., `.claude/aid/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .claude/aid/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .claude/aid/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.claude/aid/templates/grading-rubric.md`
...
`.claude/skills/<skill>/references/reviewer-brief.md`. Six per-skill briefs
...
```
ARTIFACTS UNDER REVIEW:
  - .claude/aid/templates/kb-authoring/README.md
  - .claude/aid/templates/kb-authoring/principles.md
  - .claude/aid/templates/kb-authoring/tier-model.md
  - .claude/aid/templates/kb-authoring/frontmatter-schema.md
  - .claude/aid/templates/kb-authoring/review-rubric.md
  - .claude/aid/templates/reviewer-dispatch.md  (this doc, newly authored)
  - .claude/aid/templates/generated-files.txt
  - .claude/aid/scripts/kb/build-metrics.sh
  - .claude/aid/scripts/kb/build-kb-index.sh
  - .claude/aid/templates/knowledge-base/*.md  (17 templates with prepended frontmatter)
...
DELIVERABLES:
  ...
  - Format: per .claude/aid/templates/reviewer-ledger-schema.md (ONE markdown table only)
...
- `.claude/aid/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.claude/aid/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.claude/aid/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.claude/aid/templates/grading-rubric.md` — severity → grade computation
- `.claude/aid/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
- `.claude/agents/aid-reviewer/` — the reviewer agent definition
