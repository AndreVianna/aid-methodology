...
`bash .claude/aid/scripts/...`." Don't just fix the cited file. Grep:
...
- `.claude/aid/templates/reviewer-dispatch.md` — the reviewer's protocol; the
...
- `.claude/aid/templates/subagent-heartbeat-protocol.md` — the heartbeat
