...
RULE SET: {{RULE_SET}} -- resolve via .claude/aid/templates/review-rubrics/INDEX.md
  Severity is a LOOKUP against the violated rule's anchor, per
  .claude/aid/templates/grading-rubric.md#severity-scale. Do not invent a band.
...
MISSING CRITERIA:
  ...
  see .claude/aid/templates/criteria-gap-protocol.md. Do NOT invent a criterion,
