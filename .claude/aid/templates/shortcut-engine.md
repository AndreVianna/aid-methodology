...
`.claude/aid/templates/rough-time-hints.md`. On completion, emit the closing `✓ ...
...
single-shot `.claude/skills/aid-ask/SKILL.md`, not a generated thin doorway over
INTAKE-DETAIL).
...
Copy `.claude/aid/templates/work-state-template.yml` to
