...
- POSIX: `.claude/aid/scripts/summarize/assemble-3part.sh part1.html mermaid.min.js part2.html OUTPUT`
- Windows: `.claude/aid/scripts/summarize/assemble-3part.ps1 -Part1 ... -Mermaid ... -Part2 ... -Output ...`
