...
`.claude/aid/templates/knowledge-summary/section-templates/bespoke-components.md`:
...
bash .claude/aid/scripts/summarize/assemble.sh --output .aid/dashboard/kb.html
```
