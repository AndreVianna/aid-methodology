...
bash .claude/scripts/execute/writeback-state.sh --pipeline --field Phase --value Interview
bash .claude/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value aid-interview
