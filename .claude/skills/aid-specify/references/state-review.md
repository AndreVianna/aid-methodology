...
- **Schema reference:** "Output per `.claude/aid/templates/reviewer-ledger-schema.md`. The
  ledger is the entire file — ONE markdown table, no headers, no narrative."

```bash
bash .claude/aid/scripts/grade.sh --explain .aid/.temp/review-pending/blueprint-delivery-NNN.md
```
