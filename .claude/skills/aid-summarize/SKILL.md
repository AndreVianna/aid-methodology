...
- `.claude/aid/templates/knowledge-summary/mermaid-init.js` — Mermaid theme variables for both modes
- `.claude/aid/templates/knowledge-summary/mermaid-examples.md` — one valid example per diagram type + pitfalls table
- `.claude/aid/templates/knowledge-summary/section-templates/{profile}.md` — section structure per project type
- `.claude/aid/templates/knowledge-summary/accessibility-checklist.md` — WCAG AA targets, focus trap pattern
- `.claude/aid/templates/knowledge-summary/grading-rubric.md` — two-grade rubric (Machine + Human), per-profile diagram counts
- `.claude/aid/templates/knowledge-summary/html-skeleton.html` — doctype, head, semantic landmarks, noscript
