...
bash .claude/scripts/execute/writeback-state.sh --pipeline --field Phase --value Deploy
bash .claude/scripts/execute/writeback-state.sh --pipeline --field "Active Skill" --value aid-deploy
