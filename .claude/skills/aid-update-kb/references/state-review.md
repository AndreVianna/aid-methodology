...
(`.claude/skills/aid-discover/references/state-review.md`) with the f005
...
Follow `.claude/skills/aid-discover/references/state-review.md` verbatim,
substituting:
...
```bash
bash .claude/aid/scripts/config/read-setting.sh \
...
`.claude/skills/aid-discover/references/state-fix.md` with the ledger path
