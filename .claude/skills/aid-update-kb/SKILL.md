...
**not** use `.claude/aid/scripts/works/worktree-lifecycle.sh` or
`.claude/aid/templates/work-initiation-gate.md` -- both hard-validate a
...
of `.claude/aid/templates/worktree-lifecycle.md § Step 2` only.
...
> `bash .claude/aid/scripts/config/read-setting.sh --skill update-kb --key minimum_grade --default A`
...
> `.claude/aid/templates/state-machine-chaining.md`. Mechanical states
