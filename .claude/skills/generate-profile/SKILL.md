...
- [ ] `canonical/` completeness verified against the derivation above, and the decomposition SUMS: directories = curatedOnly + catalogRows, and catalogRows = shortcuts + repurposed
