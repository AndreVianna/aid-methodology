...
Read the invocation manifest (`.claude/aid/templates/reviewer-brief-template.md` § invocation
...
- `.claude/agents/aid-screener/AGENT.md` — the agent dispatched here
- `.claude/aid/templates/reviewer-brief-template.md` — the invocation manifest
