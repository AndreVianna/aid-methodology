...
description: >
  ...
  .claude/skills/aid-change-document/SKILL.md.
...
(`.claude/skills/aid-change-document/SKILL.md`), per the alias-is-a-full-directory
...
constraint -- is defined exclusively by `.claude/skills/aid-change-document/SKILL.md`.
