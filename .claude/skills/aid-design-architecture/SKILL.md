...
(build & shape, `.claude/aid/templates/kb-authoring/concern-model.md`), never a hardcoded
...
`.claude/aid/templates/kb-authoring/domain-doc-matrix.md`, and **confirm the resolution
