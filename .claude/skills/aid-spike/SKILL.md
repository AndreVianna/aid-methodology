...
description: >
  ...
  behavior is defined by .claude/skills/aid-research/SKILL.md.
...
`/aid-spike` is the alias of **`/aid-research`** (`.claude/skills/aid-research/SKILL.md`),
...
`.claude/skills/aid-research/SKILL.md` -- including the **feasibility-spike escalation**
