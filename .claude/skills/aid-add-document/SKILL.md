...
description: >
  ...
  defined by .claude/skills/aid-create-document/SKILL.md.
...
(`.claude/skills/aid-create-document/SKILL.md`), per the alias-is-a-full-directory
convention the shortcut catalog uses (an alias is a full, separate
`.claude/skills/<name>/SKILL.md` directory, not a redirect the generator resolves).
...
`.claude/skills/aid-create-document/SKILL.md`. Read that file and execute it exactly
