...
wildcards beyond the artifact set (e.g., `.claude/templates/kb-authoring/*.md` is
...
```
RUBRIC:
  .claude/templates/kb-authoring/*.md   → kb-authoring/review-rubric.md#full-primary
  .claude/scripts/*.sh        → (none — script bugs / shell correctness)
```
...
- **Grade** computed per `.claude/templates/grading-rubric.md`
...
```
ARTIFACTS UNDER REVIEW:
  - .claude/templates/kb-authoring/README.md
  - .claude/templates/kb-authoring/principles.md
  - .claude/templates/kb-authoring/tier-model.md
  - .claude/templates/kb-authoring/frontmatter-schema.md
  - .claude/templates/kb-authoring/review-rubric.md
  ...
  - .claude/scripts/kb/verify-claims.sh  (NEW SECTIONS ONLY — see PART 0 onward)
...
This doc lives in `.claude/templates/` and is a **skill-bundle artifact**, not a KB
...
- `.claude/templates/self-review-protocol.md` — the flip side of this protocol
...
- `.claude/templates/kb-authoring/principles.md` — P3 temp-ledger pattern
- `.claude/templates/kb-authoring/review-rubric.md` — KB review rubric definitions
- `.claude/templates/grading-rubric.md` — severity → grade computation
- `.claude/templates/long-wait-protocol.md` — heartbeat / L2 timer dispatch protocol
- `.claude/agents/reviewer/` — the reviewer agent definition
