...
<!-- AUTO-GENERATED $TS by .claude/scripts/kb/build-kb-index.sh -->
...
EOF
    ...
    echo "---"
    echo ""
    echo "*To regenerate this index, run \`bash .claude/scripts/kb/build-kb-index.sh --root .aid/knowledge --output .aid/knowledge/INDEX.md\`.*"
