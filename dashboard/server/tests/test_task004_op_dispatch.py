...
class TestOpTableShape(unittest.TestCase):
    ...
    def test_op_table_seeds_the_four_feature001_rows(self):
        ...
        # task.stop/task.resume -- on top of the 4 feature-001-owned rows this
        # test originally pinned -- see test_task008_display_rename.py /
        ...
        # ops.py / test_task029_task_stop_resume_ops.py for their dedicated
        # coverage.
        self.assertEqual(
