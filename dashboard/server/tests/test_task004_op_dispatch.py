...
class TestOpTableShape(unittest.TestCase):
    ...
    def test_op_table_seeds_the_four_feature001_rows(self):
        ...
        # on top of the 4 feature-001-owned rows this test originally pinned
        # -- see test_task008_display_rename.py / test_task015_tools_update_
        # ops.py / test_task019_connector_ops.py /
