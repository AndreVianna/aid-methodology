...
- Clarify specific ambiguities when triggered by a Q&A entry in `INTERVIEW-STATE.md`
...
- Technical question beyond requirements → write a Q&A entry to `.aid/knowledge/DISCOVERY-STATE.md`
