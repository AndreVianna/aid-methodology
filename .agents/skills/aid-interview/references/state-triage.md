...
Scan `.agents/recipes/` relative to the AID installation root (the same directory that
...
`.agents/recipes/` relative to the AID installation root, i.e. the same directory
